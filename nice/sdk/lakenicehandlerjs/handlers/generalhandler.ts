 ...
 */
export class GeneralHandler implements IGeneralHandler {
     ...
     *  }
    */
	constructor(public lakeNiceClient: ILakeNiceClient, public lakeNiceAuthClient: ILakeNiceAuthClient, public generalHandlerOptions: any) {
