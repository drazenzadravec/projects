...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.LakeNiceHandler=f()}})(function(){var define,module,exports;return(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.RefreshTokenRequest_Auth={"grant_type":"","refresh_token":"","refresh_token_server_uri":""};},{}],2:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.RefreshTokenResponse_Auth={"access_token":"","token_type":"","expires_in":3600,"refresh_token":"","refresh_token_server_uri":"","resource_server_base_uri":"","scope":"","agent_id":645328,"team_id":103748};},{}],3:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.TokenClientRequest_Auth={"grant_type":"","scope":""};},{}],4:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.TokenClientResponse_Auth={"access_token":"","token_type":"","expires_in":3600,"resource_server_base_uri":"","scope":"","agent_id":645328,"team_id":103748};},{}],5:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.TokenPasswordRequest_Auth={"grant_type":"","username":"","password":"","scope":""};},{}],6:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.TokenPasswordResponse_Auth={"access_token":"","token_type":"","expires_in":3600,"refresh_token":"","refresh_token_server_uri":"","resource_server_base_uri":"","scope":"","agent_id":645328,"team_id":103748};},{}],7:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.UserCreateAccessKeyRequest_Auth={"userId":"","tenantId":""};},{}],8:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.UserCreateAccessKeyResponse_Auth={"accessKey":{"accessKeyId":"","accessKeySecret":"","userId":"","tenantId":"","isActive":true}};},{}],9:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.UserGenerateTokenRequest_Auth={"accessKeyId":"","accessKeySecret":""};},{}],10:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.UserGenerateTokenResponse_Auth={"access_token":"","token_type":"","expires_in":3600,"refresh_token":"","refresh_token_expires_in":3600,"id_token":""};},{}],11:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.UserRefreshTokenRequest_Auth={"token":""};},{}],12:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.UserRefreshTokenResponse_Auth={"token":"","tokenExpirationTimeSec":3600,"refreshToken":"","refreshTokenExpirationTimeSec":0,"sessionId":""};},{}],13:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const mockconsole=require("mockconsole");const wildemitter=require("wildemitter");const generalhandler_1=require("../handlers/generalhandler");const requesthandler_1=require("../handlers/requesthandler");const responsehandler_1=require("../handlers/responsehandler");class LakeNiceHandler{constructor(lakeNiceClient,lakeNiceAuthClient,handlerOptions){this.lakeNiceClient=lakeNiceClient;this.lakeNiceAuthClient=lakeNiceAuthClient;this.handlerOptions=handlerOptions;let self=this;let item;let options=handlerOptions||{};let config=this.config={debug:false,parent:self};let logger=function(){if(handlerOptions.debug){return handlerOptions.logger||console;}
else{return handlerOptions.logger||mockconsole;}}();this.logger=logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(LakeNiceHandler);if(this.config.debug){this.on('*',this.logger.log.bind(this.logger,'Lake Nice Handler Event:'));}
this.generalhandler=new generalhandler_1.GeneralHandler(this.lakeNiceClient,this.lakeNiceAuthClient,this.config);this.requesthandler=new requesthandler_1.RequestHandler(this.lakeNiceClient,this.lakeNiceAuthClient,this.config);this.responsehandler=new responsehandler_1.ResponseHandler(this.lakeNiceClient,this.lakeNiceAuthClient,this.config);this.generalhandler.on('*',function(){this.emit.apply(self,arguments);});this.requesthandler.on('*',function(){this.emit.apply(self,arguments);});this.responsehandler.on('*',function(){this.emit.apply(self,arguments);});this.generalhandler.on('handleDefault',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('defaultData',argum);});this.requesthandler.on('handleDefault',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('defaultData',argum);});this.responsehandler.on('handleDefault',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('defaultData',argum);});this.generalhandler.on('responseDataHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('responseData',argum);});this.requesthandler.on('responseDataHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('responseData',argum);});this.responsehandler.on('responseDataHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('responseData',argum);});this.generalhandler.on('requestDataHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('requestData',argum);});this.requesthandler.on('requestDataHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('requestData',argum);});this.responsehandler.on('requestDataHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('requestData',argum);});this.generalhandler.on('generalDataHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('generalData',argum);});this.requesthandler.on('generalDataHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('generalData',argum);});this.responsehandler.on('generalDataHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('generalData',argum);});this.generalhandler.on('getClientTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('clientToken',argum);});this.requesthandler.on('getClientTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('clientToken',argum);});this.responsehandler.on('getClientTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('clientToken',argum);});this.generalhandler.on('getImplicitTokenRequestHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('implicitTokenRequest',argum);});this.requesthandler.on('getImplicitTokenRequestHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('implicitTokenRequest',argum);});this.responsehandler.on('getImplicitTokenRequestHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('implicitTokenRequest',argum);});this.generalhandler.on('getPasswordTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('passwordToken',argum);});this.requesthandler.on('getPasswordTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('passwordToken',argum);});this.responsehandler.on('getPasswordTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('passwordToken',argum);});this.generalhandler.on('getRefreshTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('refreshToken',argum);});this.requesthandler.on('getRefreshTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('refreshToken',argum);});this.responsehandler.on('getRefreshTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('refreshToken',argum);});this.generalhandler.on('getUserRefreshTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('userRefreshToken',argum);});this.requesthandler.on('getUserRefreshTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('userRefreshToken',argum);});this.responsehandler.on('getUserRefreshTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('userRefreshToken',argum);});this.generalhandler.on('getUserCreateAccessKeyHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('userCreateAccessKey',argum);});this.requesthandler.on('getUserCreateAccessKeyHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('userCreateAccessKey',argum);});this.responsehandler.on('getUserCreateAccessKeyHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('userCreateAccessKey',argum);});this.generalhandler.on('getUserGenerateTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('userGenerateToken',argum);});this.requesthandler.on('getUserGenerateTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('userGenerateToken',argum);});this.responsehandler.on('getUserGenerateTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg};this.emit('userGenerateToken',argum);});this.generalhandler.on('getUserAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('userAccessToken',argum);});this.requesthandler.on('getUserAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('userAccessToken',argum);});this.responsehandler.on('getUserAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('userAccessToken',argum);});this.generalhandler.on('getRefreshAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('refreshAccessToken',argum);});this.requesthandler.on('getRefreshAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('refreshAccessToken',argum);});this.responsehandler.on('getRefreshAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('refreshAccessToken',argum);});this.generalhandler.on('getPasswordAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('passwordAccessToken',argum);});this.requesthandler.on('getPasswordAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('passwordAccessToken',argum);});this.responsehandler.on('getPasswordAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('passwordAccessToken',argum);});this.generalhandler.on('getClientAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('clientAccessToken',argum);});this.requesthandler.on('getClientAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('clientAccessToken',argum);});this.responsehandler.on('getClientAccessTokenHandler',function(uniqueID,arg){var argum={error:arg.error,type:arg.type,uniqueID:uniqueID,details:arg.details};this.emit('clientAccessToken',argum);});}
on(arg0,arg1){}
request(args){this.requesthandler.handleRequest(args);}
response(args){this.responsehandler.handleResponse(args);}
general(args){this.generalhandler.handleGeneral(args);}}
module.exports=LakeNiceHandler;},{"../handlers/generalhandler":45,"../handlers/requesthandler":46,"../handlers/responsehandler":47,"mockconsole":180,"wildemitter":232}],14:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HAddressBook{constructor(lakeNiceClient,addressBookHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.addressBookHandlerOptions=addressBookHandlerOptions;let self=this;let parent=addressBookHandlerOptions.parent;let item;let options=addressBookHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HAddressBook);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"createAsync":{options.data=requestData;return options;}
case"assignEntitiesAsync":{options.data=requestData;return options;}
case"dynamicEntitiesAsync":{options.params=requestData;return options;}
case"createDynamicEntitiesAsync":{options.data=requestData;return options;}
case"standardEntitiesAsync":{options.params=requestData;return options;}
case"createStandardEntitiesAsync":{options.data=requestData;return options;}
case"updateStandardEntitiesAsync":{options.data=requestData;return options;}
case"getAgentsAsync":{options.params=requestData;return options;}
case"getCampaignsAsync":{options.params=requestData;return options;}
case"getSkillsAsync":{options.params=requestData;return options;}
case"getTeamsAsync":{options.params=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HAddressBook=HAddressBook;},{"wildemitter":232}],15:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HAgents{constructor(lakeNiceClient,agentsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.agentsHandlerOptions=agentsHandlerOptions;let self=this;let parent=agentsHandlerOptions.parent;let item;let options=agentsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HAgents);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"getAgentsAsync":{options.params=requestData;return options;}
case"createAgentAsync":{options.data=requestData;return options;}
case"getAgentAsync":{options.params=requestData;return options;}
case"updateAgentAsync":{options.data=requestData;return options;}
case"setAgentStateAsync":{options.data=requestData;return options;}
case"getSkillsAssignedToAgentsAsync":{options.params=requestData;return options;}
case"getGroupsAgentAssignedAsync":{options.params=requestData;return options;}
case"removeSkillAssignedToAgentAsync":{options.data=requestData;return options;}
case"getSkillsAssignedToAgentAsync":{options.params=requestData;return options;}
case"setSkillsToAgentAsync":{options.data=requestData;return options;}
case"changeSkillForAgentAsync":{options.data=requestData;return options;}
case"getSkillsNotAssignedToAgentAsync":{options.params=requestData;return options;}
case"getAgentsContactsBySkillAsync":{options.params=requestData;return options;}
case"getAgentContactsBySkillAsync":{options.params=requestData;return options;}
case"createCustomAgentEventAsync":{options.data=requestData;return options;}
case"createAgentMessageAsync":{options.data=requestData;return options;}
case"getTeamsAsync":{options.params=requestData;return options;}
case"createTeamAsync":{options.data=requestData;return options;}
case"getTeamAsync":{options.params=requestData;return options;}
case"updateTeamAsync":{options.data=requestData;return options;}
case"getTeamsAgentsAsync":{options.params=requestData;return options;}
case"removeAgentsFromTeamAsync":{options.data=requestData;return options;}
case"getTeamAgentsAsync":{options.params=requestData;return options;}
case"setTeamAgentsAsync":{options.data=requestData;return options;}
case"removeUnavailableCodesFromTeamAsync":{options.data=requestData;return options;}
case"getOutstatesValidForTeamAsync":{options.params=requestData;return options;}
case"setUnavailableCodesToTeamAsync":{options.data=requestData;return options;}
case"updateUnavailableCodesForTeamAsync":{options.data=requestData;return options;}
case"updateUnavailableCodeAsync":{options.data=requestData;return options;}
case"setUnavailableCodeToTeamsAsync":{options.data=requestData;return options;}
case"getAccessKeysAsync":{options.params=requestData;return options;}
case"createAccessKeyAsync":{options.data=requestData;return options;}
case"updateAccessKeyAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HAgents=HAgents;},{"wildemitter":232}],16:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HContacts{constructor(lakeNiceClient,contactsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.contactsHandlerOptions=contactsHandlerOptions;let self=this;let parent=contactsHandlerOptions.parent;let item;let options=contactsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HContacts);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"getEmailTranscriptAsync":{options.params=requestData;return options;}
case"getFilesAsync":{options.params=requestData;return options;}
case"startMonitoringPhoneCallAsync":{options.data=requestData;return options;}
case"assignTagsAsync":{options.data=requestData;return options;}
case"createSignalAsync":{options.data=requestData;return options;}
case"getSMSTranscriptAsync":{options.params=requestData;return options;}
case"getPastSMSContactsAsync":{options.params=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HContacts=HContacts;},{"wildemitter":232}],17:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HGeneral{constructor(lakeNiceClient,generalHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.generalHandlerOptions=generalHandlerOptions;let self=this;let parent=generalHandlerOptions.parent;let item;let options=generalHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HGeneral);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"getBrandingProfileAsync":{options.params=requestData;return options;}
case"getBusinessUnitConfigAsync":{options.params=requestData;return options;}
case"getDispositionsAsync":{options.params=requestData;return options;}
case"removeFileAsync":{options.data=requestData;return options;}
case"getFileAsync":{options.params=requestData;return options;}
case"uploadFileAsync":{options.data=requestData;return options;}
case"moveRenameFileAsync":{options.data=requestData;return options;}
case"getUnprocessedFilesAsync":{options.params=requestData;return options;}
case"markFileForProcessingAsync":{options.data=requestData;return options;}
case"markFileAsProcessedAsync":{options.data=requestData;return options;}
case"deleteFolderAsync":{options.data=requestData;return options;}
case"getDirectoriesAsync":{options.params=requestData;return options;}
case"createHiringSourceAsync":{options.data=requestData;return options;}
case"getHoursOperationProfilesAsync":{options.params=requestData;return options;}
case"getHourOperationProfileAsync":{options.params=requestData;return options;}
case"getLocationsAsync":{options.params=requestData;return options;}
case"createMessageTemplateAsync":{options.data=requestData;return options;}
case"updateMessageTemplateAsync":{options.data=requestData;return options;}
case"getSecurityProfilesAsync":{options.params=requestData;return options;}
case"getScriptsAsync":{options.params=requestData;return options;}
case"startScriptAsync":{options.data=requestData;return options;}
case"getTagsAsync":{options.params=requestData;return options;}
case"createTagAsync":{options.data=requestData;return options;}
case"updateTagAsync":{options.data=requestData;return options;}
case"getOutStatesForBusinessUnitAsync":{options.params=requestData;return options;}
case"createHoursOperationProfileAsync":{options.data=requestData;return options;}
case"updateHoursOperationProfileAsync":{options.data=requestData;return options;}
case"createPointOfContactAsync":{options.data=requestData;return options;}
case"updatePointOfContactAsync":{options.data=requestData;return options;}
case"createUnavailableCodeAsync":{options.data=requestData;return options;}
case"getConfigurablePhoneNumbersAsync":{options.params=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HGeneral=HGeneral;},{"wildemitter":232}],18:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HGroups{constructor(lakeNiceClient,groupsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.groupsHandlerOptions=groupsHandlerOptions;let self=this;let parent=groupsHandlerOptions.parent;let item;let options=groupsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HGroups);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"getAsync":{options.params=requestData;return options;}
case"createAsync":{options.data=requestData;return options;}
case"getConfigurationAsync":{options.params=requestData;return options;}
case"modifyAsync":{options.data=requestData;return options;}
case"removeAgentsAsync":{options.data=requestData;return options;}
case"getAgentsAssignedAsync":{options.params=requestData;return options;}
case"assignAgentsAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HGroups=HGroups;},{"wildemitter":232}],19:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HLists{constructor(lakeNiceClient,listsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.listsHandlerOptions=listsHandlerOptions;let self=this;let parent=listsHandlerOptions.parent;let item;let options=listsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HLists);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"getDoNotCallGroupsAsync":{options.params=requestData;return options;}
case"createDoNotCallGroupAsync":{options.data=requestData;return options;}
case"getDoNotCallGroupAsync":{options.params=requestData;return options;}
case"updateDoNotCallGroupAsync":{options.data=requestData;return options;}
case"expireRecordsDoNotCallGroupAsync":{options.data=requestData;return options;}
case"getRecordsDoNotCallGroupAsync":{options.params=requestData;return options;}
case"addRecordsDoNotCallGroupAsync":{options.data=requestData;return options;}
case"searchPhoneNumberAsync":{options.data=requestData;return options;}
case"createCallingListMappingAsync":{options.data=requestData;return options;}
case"removeCallingListAsync":{options.params=requestData;return options;}
case"downloadCallingListAsync":{options.params=requestData;return options;}
case"downloadCallingListAttemptsAsync":{options.params=requestData;return options;}
case"uploadRecordsCallListAsync":{options.data=requestData;return options;}
case"getStatusCallingListUploadJobsAsync":{options.params=requestData;return options;}
case"getStatusCallingListUploadJobAsync":{options.params=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HLists=HLists;},{"wildemitter":232}],20:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HScheduledCallbacksAdmin{constructor(lakeNiceClient,scheduledCallbacksHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.scheduledCallbacksHandlerOptions=scheduledCallbacksHandlerOptions;let self=this;let parent=scheduledCallbacksHandlerOptions.parent;let item;let options=scheduledCallbacksHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HScheduledCallbacksAdmin);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"createAsync":{options.data=requestData;return options;}
case"updateAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HScheduledCallbacksAdmin=HScheduledCallbacksAdmin;},{"wildemitter":232}],21:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HSkills{constructor(lakeNiceClient,skillsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.skillsHandlerOptions=skillsHandlerOptions;let self=this;let parent=skillsHandlerOptions.parent;let item;let options=skillsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HSkills);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"createAsync":{options.params=requestData;return options;}
case"createDispositionAsync":{options.data=requestData;return options;}
case"getDispositionAsync":{options.params=requestData;return options;}
case"changeDispositionAsync":{options.data=requestData;return options;}
case"getDispositionClassificationsAsync":{options.params=requestData;return options;}
case"getSkillsAsync":{options.params=requestData;return options;}
case"createSkillAsync":{options.data=requestData;return options;}
case"getSkillAsync":{options.params=requestData;return options;}
case"updateSkillAsync":{options.data=requestData;return options;}
case"stopPersonalConnectionSkillAsync":{options.data=requestData;return options;}
case"getSkillAssignmentsAsync":{options.params=requestData;return options;}
case"removeSkillAssignmentAsync":{options.data=requestData;return options;}
case"getAgentsAssignedToSkillAsync":{options.params=requestData;return options;}
case"assignAgentsToSkillAsync":{options.data=requestData;return options;}
case"updateAgentAssignedSkillAsync":{options.data=requestData;return options;}
case"getAgentsNotAssignedSkillAsync":{options.params=requestData;return options;}
case"getSummaryContactsAllSkillsAsync":{options.params=requestData;return options;}
case"getSummaryContactsAllSkillAsync":{options.params=requestData;return options;}
case"getSkillDispositionsAsync":{options.params=requestData;return options;}
case"getUnassignedDispositionsAsync":{options.params=requestData;return options;}
case"removeTagsAsync":{options.data=requestData;return options;}
case"assignTagAsync":{options.data=requestData;return options;}
case"getOutboundSkillGeneralSettingsAsync":{options.params=requestData;return options;}
case"updateOutboundSkillGeneralSettingsAsync":{options.data=requestData;return options;}
case"getCPAManagementConfigurationSkillAsync":{options.params=requestData;return options;}
case"updateCPAManagementConfigurationSkillAsync":{options.data=requestData;return options;}
case"getXSConfigurationSkillAsync":{options.params=requestData;return options;}
case"updateXSConfigurationSkillAsync":{options.data=requestData;return options;}
case"getDeliveryPreferencesConfigurationSkillAsync":{options.params=requestData;return options;}
case"updateDeliveryPreferencesConfigurationSkillAsync":{options.data=requestData;return options;}
case"getRetrySettingsSkillAsync":{options.params=requestData;return options;}
case"updateRetrySettingsSkillAsync":{options.data=requestData;return options;}
case"updateScheduleSettingsSkillAsync":{options.data=requestData;return options;}
case"createCampaignAsync":{options.data=requestData;return options;}
case"updateCampaignAsync":{options.data=requestData;return options;}
case"getDispositionsSkillAssignmentAsync":{options.params=requestData;return options;}
case"deleteCampaignSkillAsync":{options.data=requestData;return options;}
case"setCampaignSkillsAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HSkills=HSkills;},{"wildemitter":232}],22:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HAgentPhone{constructor(lakeNiceClient,agentPhoneHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.agentPhoneHandlerOptions=agentPhoneHandlerOptions;let self=this;let parent=agentPhoneHandlerOptions.parent;let item;let options=agentPhoneHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HAgentPhone);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HAgentPhone=HAgentPhone;},{"wildemitter":232}],23:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HChatRequestsAgent{constructor(lakeNiceClient,chatRequestsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.chatRequestsHandlerOptions=chatRequestsHandlerOptions;let self=this;let parent=chatRequestsHandlerOptions.parent;let item;let options=chatRequestsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HChatRequestsAgent);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"sendChatTextPatronAsync":{options.data=requestData;return options;}
case"transferToAgentAsync":{options.data=requestData;return options;}
case"transferToSkillAsync":{options.data=requestData;return options;}
case"notifyPatronAgentTypingAsync":{options.data=requestData;return options;}
case"addSMSChatContactAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HChatRequestsAgent=HChatRequestsAgent;},{"wildemitter":232}],24:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HEmails{constructor(lakeNiceClient,emailsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.emailsHandlerOptions=emailsHandlerOptions;let self=this;let parent=emailsHandlerOptions.parent;let item;let options=emailsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HEmails);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"createsOutboundEmailContactAsync":{options.data=requestData;return options;}
case"forwardsEmailAsync":{options.data=requestData;return options;}
case"replyToEmailAsync":{options.data=requestData;return options;}
case"sendsEmailAsync":{options.data=requestData;return options;}
case"transferEmailToAgentAsync":{options.data=requestData;return options;}
case"transferEmailToSkillAsync":{options.data=requestData;return options;}
case"parksEmailAsync":{options.data=requestData;return options;}
case"unParksEmailAsync":{options.data=requestData;return options;}
case"saveDraftAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HEmails=HEmails;},{"wildemitter":232}],25:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HPersonalCon{constructor(lakeNiceClient,personalConHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.personalConHandlerOptions=personalConHandlerOptions;let self=this;let parent=personalConHandlerOptions.parent;let item;let options=personalConHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
...
exports.HPersonalCon=HPersonalCon;},{"wildemitter":232}],26:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HPhoneCalls{constructor(lakeNiceClient,phoneCallsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.phoneCallsHandlerOptions=phoneCallsHandlerOptions;let self=this;let parent=phoneCallsHandlerOptions.parent;let item;let options=phoneCallsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HPhoneCalls);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"dialAgentPersonalQueueAsync":{options.data=requestData;return options;}
case"dialOutboundCallAsync":{options.data=requestData;return options;}
case"dialSkillAsync":{options.data=requestData;return options;}
case"sendDtmfTonesAsync":{options.data=requestData;return options;}
case"dialAgentConsultAsync":{options.data=requestData;return options;}
case"overrideAmdCallAsync":{options.data=requestData;return options;}
case"dispositionIndependentCallAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HPhoneCalls=HPhoneCalls;},{"wildemitter":232}],27:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HScheduledCallbacksAgent{constructor(lakeNiceClient,scheduledCallbacksHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.scheduledCallbacksHandlerOptions=scheduledCallbacksHandlerOptions;let self=this;let parent=scheduledCallbacksHandlerOptions.parent;let item;let options=scheduledCallbacksHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HScheduledCallbacksAgent);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"rescheduleAsync":{options.data=requestData;return options;}
case"cancelAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HScheduledCallbacksAgent=HScheduledCallbacksAgent;},{"wildemitter":232}],28:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HSessions{constructor(lakeNiceClient,sessionsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.sessionsHandlerOptions=sessionsHandlerOptions;let self=this;let parent=sessionsHandlerOptions.parent;let item;let options=sessionsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HSessions);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"startsSessionAsync":{options.data=requestData;return options;}
case"joinExistingSessionAsync":{options.data=requestData;return options;}
case"endSessionAsync":{options.data=requestData;return options;}
case"getEventDescriptionAsync":{options.params=requestData;return options;}
case"continueReskillAsync":{options.data=requestData;return options;}
case"dispositionContactAsync":{options.data=requestData;return options;}
case"setAgentStateAsync":{options.data=requestData;return options;}
case"postFeedbackAsync":{options.data=requestData;return options;}
case"postCustomDataToContactAsync":{options.data=requestData;return options;}
case"addMediaTypeRouteAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HSessions=HSessions;},{"wildemitter":232}],29:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HSupervisor{constructor(lakeNiceClient,supervisorHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.supervisorHandlerOptions=supervisorHandlerOptions;let self=this;let parent=supervisorHandlerOptions.parent;let item;let options=supervisorHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HSupervisor);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"monitorAgentAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HSupervisor=HSupervisor;},{"wildemitter":232}],30:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HVoicemails{constructor(lakeNiceClient,voicemailsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.voicemailsHandlerOptions=voicemailsHandlerOptions;let self=this;let parent=voicemailsHandlerOptions.parent;let item;let options=voicemailsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HVoicemails);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"playVoicemailAsync":{options.data=requestData;return options;}
case"transferVoicemailToAgentAsync":{options.data=requestData;return options;}
case"transferVoicemailToSkillAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HVoicemails=HVoicemails;},{"wildemitter":232}],31:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HWorkItems{constructor(lakeNiceClient,workItemsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.workItemsHandlerOptions=workItemsHandlerOptions;let self=this;let parent=workItemsHandlerOptions.parent;let item;let options=workItemsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
...
exports.HWorkItems=HWorkItems;},{"wildemitter":232}],32:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HAuthenticate{constructor(lakeNiceClient,authenticateHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.authenticateHandlerOptions=authenticateHandlerOptions;let self=this;let parent=authenticateHandlerOptions.parent;let item;let options=authenticateHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HAuthenticate);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"resetAgentPasswordAsync":{options.data=requestData;return options;}
case"changeAgentPasswordAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HAuthenticate=HAuthenticate;},{"wildemitter":232}],33:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HSample{constructor(lakeNiceClient,sampleHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.sampleHandlerOptions=sampleHandlerOptions;let self=this;let parent=sampleHandlerOptions.parent;let item;let options=sampleHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
...
exports.HSample=HSample;},{"wildemitter":232}],34:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HCallback{constructor(lakeNiceClient,callbackHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.callbackHandlerOptions=callbackHandlerOptions;let self=this;let parent=callbackHandlerOptions.parent;let item;let options=callbackHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HCallback);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"requestImmediateCallbackAsync":{options.data=requestData;return options;}
case"scheduleCallbackAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HCallback=HCallback;},{"wildemitter":232}],35:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HChatRequestsPatron{constructor(lakeNiceClient,chatRequestsHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.chatRequestsHandlerOptions=chatRequestsHandlerOptions;let self=this;let parent=chatRequestsHandlerOptions.parent;let item;let options=chatRequestsHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HChatRequestsPatron);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"startsChatSessionAsync":{options.data=requestData;return options;}
case"getsInboundChatActiveChatSessionAsync":{options.params=requestData;return options;}
case"sendsTextMembersChatSessionAsync":{options.data=requestData;return options;}
case"notifyAgentPatronTypingAsync":{options.data=requestData;return options;}
case"sendsAgentChatPreviewAsync":{options.data=requestData;return options;}
case"sendsChatTranscriptEmailAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HChatRequestsPatron=HChatRequestsPatron;},{"wildemitter":232}],36:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HWorkItem{constructor(lakeNiceClient,workItemHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.workItemHandlerOptions=workItemHandlerOptions;let self=this;let parent=workItemHandlerOptions.parent;let item;let options=workItemHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HWorkItem);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"createWorkItemAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HWorkItem=HWorkItem;},{"wildemitter":232}],37:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HRealTime{constructor(lakeNiceClient,realTimeHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.realTimeHandlerOptions=realTimeHandlerOptions;let self=this;let parent=realTimeHandlerOptions.parent;let item;let options=realTimeHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HRealTime);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"stateAllAgentsAsync":{options.params=requestData;return options;}
case"stateAgentAsync":{options.params=requestData;return options;}
case"activeContactsAsync":{options.params=requestData;return options;}
case"parkedContactsAsync":{options.params=requestData;return options;}
case"activeContactStatesAsync":{options.params=requestData;return options;}
case"activityAllSkillsAsync":{options.params=requestData;return options;}
case"activitySkillAsync":{options.params=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HRealTime=HRealTime;},{"wildemitter":232}],38:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HReporting{constructor(lakeNiceClient,reportingHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.reportingHandlerOptions=reportingHandlerOptions;let self=this;let parent=reportingHandlerOptions.parent;let item;let options=reportingHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HReporting);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"contactHistoryAsync":{options.params=requestData;return options;}
case"recentContactsAsync":{options.params=requestData;return options;}
case"agentLoginHistoryAsync":{options.params=requestData;return options;}
case"stateDurationAsync":{options.params=requestData;return options;}
case"performanceSummaryAllAsync":{options.params=requestData;return options;}
case"performanceSummaryAsync":{options.params=requestData;return options;}
case"contactDetailsAsync":{options.params=requestData;return options;}
case"smsTranscriptsAsync":{options.params=requestData;return options;}
case"smsContactTranscriptsAsync":{options.params=requestData;return options;}
case"completedContactsAsync":{options.params=requestData;return options;}
case"statisticsForAllSkillsAsync":{options.params=requestData;return options;}
case"statisticsForASkillAsync":{options.params=requestData;return options;}
case"slaSummaryForAllSkillsAsync":{options.params=requestData;return options;}
case"slaSummaryForASkillAsync":{options.params=requestData;return options;}
case"performanceSummaryOfAllTeamsAsync":{options.params=requestData;return options;}
case"performanceSummaryOfATeamAsync":{options.params=requestData;return options;}
case"listReportingJobsAsync":{options.params=requestData;return options;}
case"reportingJobAsync":{options.params=requestData;return options;}
case"startCustomReportingJobAsync":{options.data=requestData;return options;}
case"generatesLinkToDatadownloadReportAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HReporting=HReporting;},{"wildemitter":232}],39:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HWFMData{constructor(lakeNiceClient,wfmDataHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.wfmDataHandlerOptions=wfmDataHandlerOptions;let self=this;let parent=wfmDataHandlerOptions.parent;let item;let options=wfmDataHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HWFMData);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"contactStatisticsAsync":{options.params=requestData;return options;}
case"agentMetadataAsync":{options.params=requestData;return options;}
case"dailerContactStatisticsAsync":{options.params=requestData;return options;}
case"adherenceStatisticsAsync":{options.params=requestData;return options;}
case"scorecardStatisticsAsync":{options.params=requestData;return options;}
case"agentPerformanceAsync":{options.params=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}}
exports.HWFMData=HWFMData;},{"wildemitter":232}],40:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");const modelTokenClientRequest=require("../../../json/Auth/TSTokenClientRequest");const modelTokenClientResponse=require("../../../json/Auth/TSTokenClientResponse");class HClientToken{constructor(lakeNiceAuthClient,clientTokenHandlerOptions){this.lakeNiceAuthClient=lakeNiceAuthClient;this.clientTokenHandlerOptions=clientTokenHandlerOptions;let self=this;let parent=clientTokenHandlerOptions.parent;let item;let options=clientTokenHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HClientToken);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){case"getTokenAsync":{this.getTokenAsync(argOptions);break;}
default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"getTokenAsync":{options.data=requestData;return options;}
case"getTokenAsyncOv":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}
getAccessTokenAsync(authorizationKey,requestOptions){let localParent=this.parent;let requestData=modelTokenClientRequest.TokenClientRequest_Auth;requestData.grant_type="client_credentials";this.lakeNiceAuthClient.getAuthClient().getAuthRequest().assignOptions(requestData,requestOptions);let requestConfig={domainURIPath:"https://au1.nice-incontact.com",baseURIPath:"/InContactAuthorizationServer/Token",data:requestData,headers:{'Authorization':'Basic '+authorizationKey}};this.lakeNiceAuthClient.getAuthClient().getAuthRequest().assignOptions(requestConfig,requestOptions);this.lakeNiceAuthClient.getAuthClient().getClientToken().getTokenAsyncOv(requestConfig,function(id,response){let responseData=modelTokenClientResponse.TokenClientResponse_Auth;let data=response.data;responseData=data;var argum={error:false,type:'response',details:response};localParent.emit('getClientAccessTokenHandler',id,argum);});}
getTokenAsync(argOptions){let localParent=this.parent;localParent.emit('getClientTokenHandler',argOptions.uniqueID,argOptions);}}
exports.HClientToken=HClientToken;},{"../../../json/Auth/TSTokenClientRequest":3,"../../../json/Auth/TSTokenClientResponse":4,"wildemitter":232}],41:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");class HImplicitToken{constructor(lakeNiceAuthClient,implicitTokenHandlerOptions){this.lakeNiceAuthClient=lakeNiceAuthClient;this.implicitTokenHandlerOptions=implicitTokenHandlerOptions;let self=this;let parent=implicitTokenHandlerOptions.parent;let item;let options=implicitTokenHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HImplicitToken);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){case"getTokenRequest":{this.getTokenRequest(argOptions);break;}
default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"getTokenRequest":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}
getTokenRequest(argOptions){let localParent=this.parent;localParent.emit('getImplicitTokenRequestHandler',argOptions.uniqueID,argOptions);}}
exports.HImplicitToken=HImplicitToken;},{"wildemitter":232}],42:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");const modelTokenPasswordRequest=require("../../../json/Auth/TSTokenPasswordRequest");const modelTokenPasswordResponse=require("../../../json/Auth/TSTokenPasswordResponse");class HPasswordToken{constructor(lakeNiceAuthClient,passwordTokenHandlerOptions){this.lakeNiceAuthClient=lakeNiceAuthClient;this.passwordTokenHandlerOptions=passwordTokenHandlerOptions;let self=this;let parent=passwordTokenHandlerOptions.parent;let item;let options=passwordTokenHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
...
getAccessTokenAsync(authorizationKey,requestOptions){let localParent=this.parent;let requestData=modelTokenPasswordRequest.TokenPasswordRequest_Auth;requestData.grant_type="password";this.lakeNiceAuthClient.getAuthClient().getAuthRequest().assignOptions(requestData,requestOptions);let requestConfig={domainURIPath:"https://au1.nice-incontact.com",baseURIPath:"/InContactAuthorizationServer/Token",data:requestData,headers:{'Authorization':'Basic '+authorizationKey}};this.lakeNiceAuthClient.getAuthClient().getAuthRequest().assignOptions(requestConfig,requestOptions);this.lakeNiceAuthClient.getAuthClient().getPasswordToken().getTokenAsyncOv(requestConfig,function(id,response){let responseData=modelTokenPasswordResponse.TokenPasswordResponse_Auth;let data=response.data;responseData=data;var argum={error:false,type:'response',details:response};localParent.emit('getPasswordAccessTokenHandler',id,argum);});}
getTokenAsync(argOptions){let localParent=this.parent;localParent.emit('getPasswordTokenHandler',argOptions.uniqueID,argOptions);}}
exports.HPasswordToken=HPasswordToken;},{"../../../json/Auth/TSTokenPasswordRequest":5,"../../../json/Auth/TSTokenPasswordResponse":6,"wildemitter":232}],43:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const wildemitter=require("wildemitter");const modelRefreshTokenRequest=require("../../../json/Auth/TSRefreshTokenRequest");const modelRefreshTokenResponse=require("../../../json/Auth/TSRefreshTokenResponse");class HRefreshToken{constructor(lakeNiceAuthClient,refreshTokenHandlerOptions){this.lakeNiceAuthClient=lakeNiceAuthClient;this.refreshTokenHandlerOptions=refreshTokenHandlerOptions;let self=this;let parent=refreshTokenHandlerOptions.parent;let item;let options=refreshTokenHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
...
getAccessTokenAsync(authorizationKey,requestOptions){let localParent=this.parent;let requestData=modelRefreshTokenRequest.RefreshTokenRequest_Auth;requestData.grant_type="refresh_token";this.lakeNiceAuthClient.getAuthClient().getAuthRequest().assignOptions(requestData,requestOptions);let requestConfig={domainURIPath:requestData.refresh_token_server_uri,baseURIPath:'',data:requestData,headers:{'Authorization':'Basic '+authorizationKey}};this.lakeNiceAuthClient.getAuthClient().getAuthRequest().assignOptions(requestConfig,requestOptions);this.lakeNiceAuthClient.getAuthClient().getRefreshToken().getTokenAsyncOv(requestConfig,function(id,response){let responseData=modelRefreshTokenResponse.RefreshTokenResponse_Auth;let data=response.data;responseData=data;var argum={error:false,type:'response',details:response};localParent.emit('getRefreshAccessTokenHandler',id,argum);});}
getTokenAsync(argOptions){let localParent=this.parent;localParent.emit('getRefreshTokenHandler',argOptions.uniqueID,argOptions);}}
exports.HRefreshToken=HRefreshToken;},{"../../../json/Auth/TSRefreshTokenRequest":1,"../../../json/Auth/TSRefreshTokenResponse":2,"wildemitter":232}],44:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const jwt=require("jsonwebtoken");const wildemitter=require("wildemitter");const modelUserRefreshTokenRequest=require("../../../json/Auth/TSUserRefreshTokenRequest");const modelUserRefreshTokenResponse=require("../../../json/Auth/TSUserRefreshTokenResponse");const modelUserCreateAccessKeyRequest=require("../../../json/Auth/TSUserCreateAccessKeyRequest");const modelUserCreateAccessKeyResponse=require("../../../json/Auth/TSUserCreateAccessKeyResponse");const modelUserGenerateTokenRequest=require("../../../json/Auth/TSUserGenerateTokenRequest");const modelUserGenerateTokenResponse=require("../../../json/Auth/TSUserGenerateTokenResponse");class HUserToken{constructor(lakeNiceAuthClient,userTokenHandlerOptions){this.lakeNiceAuthClient=lakeNiceAuthClient;this.userTokenHandlerOptions=userTokenHandlerOptions;let self=this;let parent=userTokenHandlerOptions.parent;let item;let options=userTokenHandlerOptions||{};let config=this.config={debug:false};this.parent=parent;this.logger=parent.logger;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
wildemitter.mixin(HUserToken);}
handleAction(argOptions){let id=argOptions.uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];switch(requestMethod){case"getRefreshTokenAsync":{this.getRefreshTokenAsync(argOptions);break;}
case"getCreateAccessKeyAsync":{this.getCreateAccessKeyAsync(argOptions);break;}
case"getGenerateTokenAsync":{this.getGenerateTokenAsync(argOptions);break;}
default:{this.handleDefaultAction(argOptions);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let requestMethod=ids[2];let options={params:{},data:{}};switch(requestMethod){case"getRefreshTokenAsync":{options.data=requestData;return options;}
case"getCreateAccessKeyAsync":{options.data=requestData;return options;}
case"getGenerateTokenAsync":{options.data=requestData;return options;}
default:{return options;}}}}
handleDefaultAction(argOptions){let localParent=this.parent;if(argOptions.type!=='general'){if(argOptions.type==='response'){localParent.emit('responseDataHandler',argOptions.uniqueID,argOptions);}
if(argOptions.type==='request'){localParent.emit('requestDataHandler',argOptions.uniqueID,argOptions);}}
else{localParent.emit('generalDataHandler',argOptions.uniqueID,argOptions);}}
getAccessTokenAsync(refreshToken,requestOptions){let localThis=this;let requestData=modelUserRefreshTokenRequest.UserRefreshTokenRequest_Auth;requestData.token=refreshToken;let baseURIPathOptions={refreshBaseURIPath:"/public/user/refresh",accesskeyBaseURIPath:"/access-key-management/v1/access-keys",generateBaseURIPath:"/authentication/v1/token/access-key"};this.lakeNiceAuthClient.getAuthClient().getAuthRequest().assignOptions(baseURIPathOptions,requestOptions);let requestConfig={domainURIPath:"https://au1.nice-incontact.com",baseURIPath:baseURIPathOptions.refreshBaseURIPath,data:requestData,headers:{'Authorization':''}};this.lakeNiceAuthClient.getAuthClient().getAuthRequest().assignOptions(requestConfig,requestOptions);this.lakeNiceAuthClient.getAuthClient().getUserToken().getRefreshTokenAsyncOv(requestConfig,function(id,response){let responseData=modelUserRefreshTokenResponse.UserRefreshTokenResponse_Auth;let data=response.data;responseData=data;localThis.getUserCreateAccessKey(responseData,requestConfig,baseURIPathOptions);});}
getUserCreateAccessKey(refreshTokenData,requestConfig,baseURIPathOptions){let localThis=this;let responseTokenData=modelUserRefreshTokenResponse.UserRefreshTokenResponse_Auth;let refreshData=refreshTokenData;responseTokenData=refreshData;let decoded=jwt.decode(responseTokenData.token,{complete:true});let requestData=modelUserCreateAccessKeyRequest.UserCreateAccessKeyRequest_Auth;requestData.tenantId=decoded.payload.tenantId;requestData.userId=decoded.payload.sub.replace('user:','');let requestOptions={baseURIPath:baseURIPathOptions.accesskeyBaseURIPath,data:requestData,headers:{'Authorization':'Bearer '+responseTokenData.token}};this.lakeNiceAuthClient.getAuthClient().getAuthRequest().assignOptions(requestConfig,requestOptions);this.lakeNiceAuthClient.getAuthClient().getUserToken().getCreateAccessKeyAsyncOv(requestConfig,function(id,response){let responseData=modelUserCreateAccessKeyResponse.UserCreateAccessKeyResponse_Auth;let data=response.data;responseData=data;localThis.getUserGenerateToken(responseData,requestConfig,baseURIPathOptions);});}
getUserGenerateToken(createAccessKeyData,requestConfig,baseURIPathOptions){let localThis=this;let localParent=this.parent;let responseAccessKeyData=modelUserCreateAccessKeyResponse.UserCreateAccessKeyResponse_Auth;let refreshData=createAccessKeyData;responseAccessKeyData=refreshData;let requestData=modelUserGenerateTokenRequest.UserGenerateTokenRequest_Auth;requestData.accessKeyId=responseAccessKeyData.accessKey.accessKeyId;requestData.accessKeySecret=responseAccessKeyData.accessKey.accessKeySecret;let requestOptions={baseURIPath:baseURIPathOptions.generateBaseURIPath,data:requestData,headers:{'Authorization':''}};this.lakeNiceAuthClient.getAuthClient().getUserToken().getGenerateTokenAsyncOv(requestConfig,function(id,response){let responseData=modelUserGenerateTokenResponse.UserGenerateTokenResponse_Auth;let data=response.data;responseData=data;var argum={error:false,type:'response',details:response};localParent.emit('getUserAccessTokenHandler',id,argum);});}
getRefreshTokenAsync(argOptions){let localParent=this.parent;localParent.emit('getUserRefreshTokenHandler',argOptions.uniqueID,argOptions);}
getCreateAccessKeyAsync(argOptions){let localParent=this.parent;localParent.emit('getUserCreateAccessKeyHandler',argOptions.uniqueID,argOptions);}
getGenerateTokenAsync(argOptions){let localParent=this.parent;localParent.emit('getUserGenerateTokenHandler',argOptions.uniqueID,argOptions);}}
exports.HUserToken=HUserToken;},{"../../../json/Auth/TSUserCreateAccessKeyRequest":7,"../../../json/Auth/TSUserCreateAccessKeyResponse":8,"../../../json/Auth/TSUserGenerateTokenRequest":9,"../../../json/Auth/TSUserGenerateTokenResponse":10,"../../../json/Auth/TSUserRefreshTokenRequest":11,"../../../json/Auth/TSUserRefreshTokenResponse":12,"jsonwebtoken":154,"wildemitter":232}],45:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const mockconsole=require("mockconsole");const wildemitter=require("wildemitter");const clienttoken_1=require("./auth/clienttoken");const implicittoken_1=require("./auth/implicittoken");const passwordtoken_1=require("./auth/passwordtoken");const refreshtoken_1=require("./auth/refreshtoken");const usertoken_1=require("./auth/usertoken");const addressbook_1=require("./api/admin/addressbook");const agents_1=require("./api/admin/agents");const contacts_1=require("./api/admin/contacts");const general_1=require("./api/admin/general");const groups_1=require("./api/admin/groups");const lists_1=require("./api/admin/lists");const scheduledcallbacks_admin_1=require("./api/admin/scheduledcallbacks-admin");const skills_1=require("./api/admin/skills");const agentphone_1=require("./api/agent/agentphone");const chatrequests_agent_1=require("./api/agent/chatrequests-agent");const emails_1=require("./api/agent/emails");const personalcon_1=require("./api/agent/personalcon");const phonecalls_1=require("./api/agent/phonecalls");const scheduledcallbacks_agent_1=require("./api/agent/scheduledcallbacks-agent");const sessions_1=require("./api/agent/sessions");const supervisor_1=require("./api/agent/supervisor");const voicemails_1=require("./api/agent/voicemails");const workitems_1=require("./api/agent/workitems");const authenticate_1=require("./api/authentication/authenticate");const sample_1=require("./api/custom/sample");const callback_1=require("./api/patron/callback");const chatrequests_patron_1=require("./api/patron/chatrequests-patron");const workitem_1=require("./api/patron/workitem");const realtime_1=require("./api/realtimedata/realtime");const reporting_1=require("./api/reporting/reporting");const wfmdata_1=require("./api/reporting/wfmdata");class GeneralHandler{constructor(lakeNiceClient,lakeNiceAuthClient,generalHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.lakeNiceAuthClient=lakeNiceAuthClient;this.generalHandlerOptions=generalHandlerOptions;let self=this;let parent=generalHandlerOptions.parent;let item;let options=generalHandlerOptions||{};let config=this.config={debug:false};wildemitter.mixin(GeneralHandler);let logger=function(){if(generalHandlerOptions.debug){return generalHandlerOptions.logger||console;}
else{return generalHandlerOptions.logger||mockconsole;}}();this.logger=logger;this.parent=parent;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
...
this.clienttoken=new clienttoken_1.HClientToken(this.lakeNiceAuthClient,this.config);this.implicittoken=new implicittoken_1.HImplicitToken(this.lakeNiceAuthClient,this.config);this.passwordtoken=new passwordtoken_1.HPasswordToken(this.lakeNiceAuthClient,this.config);this.refreshtoken=new refreshtoken_1.HRefreshToken(this.lakeNiceAuthClient,this.config);this.usertoken=new usertoken_1.HUserToken(this.lakeNiceAuthClient,this.config);this.addressbook=new addressbook_1.HAddressBook(this.lakeNiceClient,this.config);this.agents=new agents_1.HAgents(this.lakeNiceClient,this.config);this.contacts=new contacts_1.HContacts(this.lakeNiceClient,this.config);this.general=new general_1.HGeneral(this.lakeNiceClient,this.config);this.groups=new groups_1.HGroups(this.lakeNiceClient,this.config);this.lists=new lists_1.HLists(this.lakeNiceClient,this.config);this.scheduledcallbacksadmin=new scheduledcallbacks_admin_1.HScheduledCallbacksAdmin(this.lakeNiceClient,this.config);this.skills=new skills_1.HSkills(this.lakeNiceClient,this.config);this.agentphone=new agentphone_1.HAgentPhone(this.lakeNiceClient,this.config);this.chatrequestsagent=new chatrequests_agent_1.HChatRequestsAgent(this.lakeNiceClient,this.config);this.emails=new emails_1.HEmails(this.lakeNiceClient,this.config);this.personalcon=new personalcon_1.HPersonalCon(this.lakeNiceClient,this.config);this.phonecalls=new phonecalls_1.HPhoneCalls(this.lakeNiceClient,this.config);this.scheduledcallbacksagent=new scheduledcallbacks_agent_1.HScheduledCallbacksAgent(this.lakeNiceClient,this.config);this.sessions=new sessions_1.HSessions(this.lakeNiceClient,this.config);this.supervisor=new supervisor_1.HSupervisor(this.lakeNiceClient,this.config);this.voicemails=new voicemails_1.HVoicemails(this.lakeNiceClient,this.config);this.workitems=new workitems_1.HWorkItems(this.lakeNiceClient,this.config);this.authenticate=new authenticate_1.HAuthenticate(this.lakeNiceClient,this.config);this.sample=new sample_1.HSample(this.lakeNiceClient,this.config);this.callback=new callback_1.HCallback(this.lakeNiceClient,this.config);this.chatrequestspatron=new chatrequests_patron_1.HChatRequestsPatron(this.lakeNiceClient,this.config);this.workitem=new workitem_1.HWorkItem(this.lakeNiceClient,this.config);this.realtime=new realtime_1.HRealTime(this.lakeNiceClient,this.config);this.reporting=new reporting_1.HReporting(this.lakeNiceClient,this.config);this.wfmdata=new wfmdata_1.HWFMData(this.lakeNiceClient,this.config);}
on(arg0,arg1){}
getClientToken(){return this.clienttoken;}
getImplicitToken(){return this.implicittoken;}
getPasswordToken(){return this.passwordtoken;}
getRefreshToken(){return this.refreshtoken;}
getUserToken(){return this.usertoken;}
handleGeneral(args){let localParent=this.parent;let id=args.uniqueID.toString();let ids=id.split('.');let endPoint=ids[0]+"."+ids[1];switch(endPoint){case"Auth.ClientToken":{this.clienttoken.handleAction(args);break;}
case"Auth.ImplicitToken":{this.implicittoken.handleAction(args);break;}
case"Auth.PasswordToken":{this.passwordtoken.handleAction(args);break;}
case"Auth.RefreshToken":{this.refreshtoken.handleAction(args);break;}
case"Auth.UserToken":{this.usertoken.handleAction(args);break;}
case"Admin.AddressBook":{this.addressbook.handleAction(args);break;}
case"Admin.Agents":{this.agents.handleAction(args);break;}
case"Admin.Contacts":{this.contacts.handleAction(args);break;}
case"Admin.General":{this.general.handleAction(args);break;}
case"Admin.Groups":{this.groups.handleAction(args);break;}
case"Admin.Lists":{this.lists.handleAction(args);break;}
case"Admin.ScheduledCallbacks":{this.scheduledcallbacksadmin.handleAction(args);break;}
case"Admin.Skills":{this.skills.handleAction(args);break;}
case"Agent.AgentPhone":{this.agentphone.handleAction(args);break;}
case"Agent.ChatRequests":{this.chatrequestsagent.handleAction(args);break;}
case"Agent.Emails":{this.emails.handleAction(args);break;}
case"Agent.PersonalCon":{this.personalcon.handleAction(args);break;}
case"Agent.PhoneCalls":{this.phonecalls.handleAction(args);break;}
case"Agent.ScheduledCallbacks":{this.scheduledcallbacksagent.handleAction(args);break;}
case"Agent.Sessions":{this.sessions.handleAction(args);break;}
case"Agent.Supervisor":{this.supervisor.handleAction(args);break;}
case"Agent.Voicemails":{this.voicemails.handleAction(args);break;}
case"Agent.WorkItems":{this.workitems.handleAction(args);break;}
case"Authentication.Authenticate":{this.authenticate.handleAction(args);break;}
case"Custom.Sample":{this.sample.handleAction(args);break;}
case"Patron.Callback":{this.callback.handleAction(args);break;}
case"Patron.ChatRequests":{this.chatrequestspatron.handleAction(args);break;}
case"Patron.WorkItem":{this.workitem.handleAction(args);break;}
case"RealTimeData.RealTime":{this.realtime.handleAction(args);break;}
case"Reporting.Reporting":{this.reporting.handleAction(args);break;}
case"Reporting.WFMData":{this.wfmdata.handleAction(args);break;}
default:{localParent.emit('handleDefault',id,args);break;}}}
assignRequestOptions(uniqueID,requestData){if(requestData===null){let options={params:{},data:{}};return options;}
else{let id=uniqueID.toString();let ids=id.split('.');let endPoint=ids[0]+"."+ids[1];let options={params:{},data:{}};switch(endPoint){case"Auth.ClientToken":{return this.clienttoken.assignRequestOptions(uniqueID,requestData);}
case"Auth.ImplicitToken":{return this.implicittoken.assignRequestOptions(uniqueID,requestData);}
case"Auth.PasswordToken":{return this.passwordtoken.assignRequestOptions(uniqueID,requestData);}
case"Auth.RefreshToken":{return this.refreshtoken.assignRequestOptions(uniqueID,requestData);;}
case"Auth.UserToken":{return this.usertoken.assignRequestOptions(uniqueID,requestData);}
case"Admin.AddressBook":{return this.addressbook.assignRequestOptions(uniqueID,requestData);}
case"Admin.Agents":{return this.agents.assignRequestOptions(uniqueID,requestData);}
case"Admin.Contacts":{return this.contacts.assignRequestOptions(uniqueID,requestData);}
case"Admin.General":{return this.general.assignRequestOptions(uniqueID,requestData);}
case"Admin.Groups":{return this.groups.assignRequestOptions(uniqueID,requestData);}
case"Admin.Lists":{return this.lists.assignRequestOptions(uniqueID,requestData);}
case"Admin.ScheduledCallbacks":{return this.scheduledcallbacksadmin.assignRequestOptions(uniqueID,requestData);}
case"Admin.Skills":{return this.skills.assignRequestOptions(uniqueID,requestData);}
case"Agent.AgentPhone":{return this.agentphone.assignRequestOptions(uniqueID,requestData);}
case"Agent.ChatRequests":{return this.chatrequestsagent.assignRequestOptions(uniqueID,requestData);}
case"Agent.Emails":{return this.emails.assignRequestOptions(uniqueID,requestData);}
case"Agent.PersonalCon":{return this.personalcon.assignRequestOptions(uniqueID,requestData);}
case"Agent.PhoneCalls":{return this.phonecalls.assignRequestOptions(uniqueID,requestData);}
case"Agent.ScheduledCallbacks":{return this.scheduledcallbacksagent.assignRequestOptions(uniqueID,requestData);}
case"Agent.Sessions":{return this.sessions.assignRequestOptions(uniqueID,requestData);}
case"Agent.Supervisor":{return this.supervisor.assignRequestOptions(uniqueID,requestData);}
case"Agent.Voicemails":{return this.voicemails.assignRequestOptions(uniqueID,requestData);}
case"Agent.WorkItems":{return this.workitems.assignRequestOptions(uniqueID,requestData);}
case"Authentication.Authenticate":{return this.authenticate.assignRequestOptions(uniqueID,requestData);}
case"Custom.Sample":{return this.sample.assignRequestOptions(uniqueID,requestData);}
case"Patron.Callback":{return this.callback.assignRequestOptions(uniqueID,requestData);}
case"Patron.ChatRequests":{return this.chatrequestspatron.assignRequestOptions(uniqueID,requestData);}
case"Patron.WorkItem":{return this.workitem.assignRequestOptions(uniqueID,requestData);}
case"RealTimeData.RealTime":{return this.realtime.assignRequestOptions(uniqueID,requestData);}
case"Reporting.Reporting":{return this.reporting.assignRequestOptions(uniqueID,requestData);}
case"Reporting.WFMData":{return this.wfmdata.assignRequestOptions(uniqueID,requestData);}
default:{return options;}}}}}
exports.GeneralHandler=GeneralHandler;},{"./api/admin/addressbook":14,"./api/admin/agents":15,"./api/admin/contacts":16,"./api/admin/general":17,"./api/admin/groups":18,"./api/admin/lists":19,"./api/admin/scheduledcallbacks-admin":20,"./api/admin/skills":21,"./api/agent/agentphone":22,"./api/agent/chatrequests-agent":23,"./api/agent/emails":24,"./api/agent/personalcon":25,"./api/agent/phonecalls":26,"./api/agent/scheduledcallbacks-agent":27,"./api/agent/sessions":28,"./api/agent/supervisor":29,"./api/agent/voicemails":30,"./api/agent/workitems":31,"./api/authentication/authenticate":32,"./api/custom/sample":33,"./api/patron/callback":34,"./api/patron/chatrequests-patron":35,"./api/patron/workitem":36,"./api/realtimedata/realtime":37,"./api/reporting/reporting":38,"./api/reporting/wfmdata":39,"./auth/clienttoken":40,"./auth/implicittoken":41,"./auth/passwordtoken":42,"./auth/refreshtoken":43,"./auth/usertoken":44,"mockconsole":180,"wildemitter":232}],46:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const mockconsole=require("mockconsole");const wildemitter=require("wildemitter");const clienttoken_1=require("./auth/clienttoken");const implicittoken_1=require("./auth/implicittoken");const passwordtoken_1=require("./auth/passwordtoken");const refreshtoken_1=require("./auth/refreshtoken");const usertoken_1=require("./auth/usertoken");const addressbook_1=require("./api/admin/addressbook");const agents_1=require("./api/admin/agents");const contacts_1=require("./api/admin/contacts");const general_1=require("./api/admin/general");const groups_1=require("./api/admin/groups");const lists_1=require("./api/admin/lists");const scheduledcallbacks_admin_1=require("./api/admin/scheduledcallbacks-admin");const skills_1=require("./api/admin/skills");const agentphone_1=require("./api/agent/agentphone");const chatrequests_agent_1=require("./api/agent/chatrequests-agent");const emails_1=require("./api/agent/emails");const personalcon_1=require("./api/agent/personalcon");const phonecalls_1=require("./api/agent/phonecalls");const scheduledcallbacks_agent_1=require("./api/agent/scheduledcallbacks-agent");const sessions_1=require("./api/agent/sessions");const supervisor_1=require("./api/agent/supervisor");const voicemails_1=require("./api/agent/voicemails");const workitems_1=require("./api/agent/workitems");const authenticate_1=require("./api/authentication/authenticate");const sample_1=require("./api/custom/sample");const callback_1=require("./api/patron/callback");const chatrequests_patron_1=require("./api/patron/chatrequests-patron");const workitem_1=require("./api/patron/workitem");const realtime_1=require("./api/realtimedata/realtime");const reporting_1=require("./api/reporting/reporting");const wfmdata_1=require("./api/reporting/wfmdata");class RequestHandler{constructor(lakeNiceClient,lakeNiceAuthClient,requestHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.lakeNiceAuthClient=lakeNiceAuthClient;this.requestHandlerOptions=requestHandlerOptions;let self=this;let parent=requestHandlerOptions.parent;let item;let options=requestHandlerOptions||{};let config=this.config={debug:false};wildemitter.mixin(RequestHandler);let logger=function(){if(requestHandlerOptions.debug){return requestHandlerOptions.logger||console;}
else{return requestHandlerOptions.logger||mockconsole;}}();this.logger=logger;this.parent=parent;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
this.config.parent=self;if(this.config.debug){this.on('*',function(event,val1,val2,val3){var logger;if(self.config.logger===mockconsole){logger=console;}
else{logger=self.logger;}
...
getRefreshToken(){return this.refreshtoken;}
getUserToken(){return this.usertoken;}
handleRequest(args){let localParent=this.parent;let id=args.uniqueID.toString();let ids=id.split('.');let endPoint=ids[0]+"."+ids[1];switch(endPoint){case"Auth.ClientToken":{this.clienttoken.handleAction(args);break;}
case"Auth.ImplicitToken":{this.implicittoken.handleAction(args);break;}
case"Auth.PasswordToken":{this.passwordtoken.handleAction(args);break;}
case"Auth.RefreshToken":{this.refreshtoken.handleAction(args);break;}
case"Auth.UserToken":{this.usertoken.handleAction(args);break;}
...
case"Reporting.WFMData":{return this.wfmdata.assignRequestOptions(uniqueID,requestData);}
default:{return options;}}}}}
exports.RequestHandler=RequestHandler;},{"./api/admin/addressbook":14,"./api/admin/agents":15,"./api/admin/contacts":16,"./api/admin/general":17,"./api/admin/groups":18,"./api/admin/lists":19,"./api/admin/scheduledcallbacks-admin":20,"./api/admin/skills":21,"./api/agent/agentphone":22,"./api/agent/chatrequests-agent":23,"./api/agent/emails":24,"./api/agent/personalcon":25,"./api/agent/phonecalls":26,"./api/agent/scheduledcallbacks-agent":27,"./api/agent/sessions":28,"./api/agent/supervisor":29,"./api/agent/voicemails":30,"./api/agent/workitems":31,"./api/authentication/authenticate":32,"./api/custom/sample":33,"./api/patron/callback":34,"./api/patron/chatrequests-patron":35,"./api/patron/workitem":36,"./api/realtimedata/realtime":37,"./api/reporting/reporting":38,"./api/reporting/wfmdata":39,"./auth/clienttoken":40,"./auth/implicittoken":41,"./auth/passwordtoken":42,"./auth/refreshtoken":43,"./auth/usertoken":44,"mockconsole":180,"wildemitter":232}],47:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});const mockconsole=require("mockconsole");const wildemitter=require("wildemitter");const clienttoken_1=require("./auth/clienttoken");const implicittoken_1=require("./auth/implicittoken");const passwordtoken_1=require("./auth/passwordtoken");const refreshtoken_1=require("./auth/refreshtoken");const usertoken_1=require("./auth/usertoken");const addressbook_1=require("./api/admin/addressbook");const agents_1=require("./api/admin/agents");const contacts_1=require("./api/admin/contacts");const general_1=require("./api/admin/general");const groups_1=require("./api/admin/groups");const lists_1=require("./api/admin/lists");const scheduledcallbacks_admin_1=require("./api/admin/scheduledcallbacks-admin");const skills_1=require("./api/admin/skills");const agentphone_1=require("./api/agent/agentphone");const chatrequests_agent_1=require("./api/agent/chatrequests-agent");const emails_1=require("./api/agent/emails");const personalcon_1=require("./api/agent/personalcon");const phonecalls_1=require("./api/agent/phonecalls");const scheduledcallbacks_agent_1=require("./api/agent/scheduledcallbacks-agent");const sessions_1=require("./api/agent/sessions");const supervisor_1=require("./api/agent/supervisor");const voicemails_1=require("./api/agent/voicemails");const workitems_1=require("./api/agent/workitems");const authenticate_1=require("./api/authentication/authenticate");const sample_1=require("./api/custom/sample");const callback_1=require("./api/patron/callback");const chatrequests_patron_1=require("./api/patron/chatrequests-patron");const workitem_1=require("./api/patron/workitem");const realtime_1=require("./api/realtimedata/realtime");const reporting_1=require("./api/reporting/reporting");const wfmdata_1=require("./api/reporting/wfmdata");class ResponseHandler{constructor(lakeNiceClient,lakeNiceAuthClient,responseHandlerOptions){this.lakeNiceClient=lakeNiceClient;this.lakeNiceAuthClient=lakeNiceAuthClient;this.responseHandlerOptions=responseHandlerOptions;let self=this;let parent=responseHandlerOptions.parent;let item;let options=responseHandlerOptions||{};let config=this.config={debug:false};wildemitter.mixin(ResponseHandler);let logger=function(){if(responseHandlerOptions.debug){return responseHandlerOptions.logger||console;}
else{return responseHandlerOptions.logger||mockconsole;}}();this.logger=logger;this.parent=parent;for(item in options){if(options.hasOwnProperty(item)){this.config[item]=options[item];}}
this.config.parent=self;if(this.config.debug){this.on('*',function(event,val1,val2,val3){var logger;if(self.config.logger===mockconsole){logger=console;}
else{logger=self.logger;}
...
getRefreshToken(){return this.refreshtoken;}
getUserToken(){return this.usertoken;}
handleResponse(args){let localParent=this.parent;let id=args.uniqueID.toString();let ids=id.split('.');let endPoint=ids[0]+"."+ids[1];switch(endPoint){case"Auth.ClientToken":{this.clienttoken.handleAction(args);break;}
case"Auth.ImplicitToken":{this.implicittoken.handleAction(args);break;}
case"Auth.PasswordToken":{this.passwordtoken.handleAction(args);break;}
case"Auth.RefreshToken":{this.refreshtoken.handleAction(args);break;}
case"Auth.UserToken":{this.usertoken.handleAction(args);break;}
...
case"Reporting.WFMData":{return this.wfmdata.assignRequestOptions(uniqueID,requestData);}
default:{return options;}}}}}
exports.ResponseHandler=ResponseHandler;},{"./api/admin/addressbook":14,"./api/admin/agents":15,"./api/admin/contacts":16,"./api/admin/general":17,"./api/admin/groups":18,"./api/admin/lists":19,"./api/admin/scheduledcallbacks-admin":20,"./api/admin/skills":21,"./api/agent/agentphone":22,"./api/agent/chatrequests-agent":23,"./api/agent/emails":24,"./api/agent/personalcon":25,"./api/agent/phonecalls":26,"./api/agent/scheduledcallbacks-agent":27,"./api/agent/sessions":28,"./api/agent/supervisor":29,"./api/agent/voicemails":30,"./api/agent/workitems":31,"./api/authentication/authenticate":32,"./api/custom/sample":33,"./api/patron/callback":34,"./api/patron/chatrequests-patron":35,"./api/patron/workitem":36,"./api/realtimedata/realtime":37,"./api/reporting/reporting":38,"./api/reporting/wfmdata":39,"./auth/clienttoken":40,"./auth/implicittoken":41,"./auth/passwordtoken":42,"./auth/refreshtoken":43,"./auth/usertoken":44,"mockconsole":180,"wildemitter":232}],48:[function(require,module,exports){var asn1=exports;asn1.bignum=require('bn.js');asn1.define=require('./asn1/api').define;asn1.base=require('./asn1/base');asn1.constants=require('./asn1/constants');asn1.decoders=require('./asn1/decoders');asn1.encoders=require('./asn1/encoders');},{"./asn1/api":49,"./asn1/base":51,"./asn1/constants":55,"./asn1/decoders":57,"./asn1/encoders":60,"bn.js":63}],49:[function(require,module,exports){var asn1=require('../asn1');var inherits=require('inherits');var api=exports;api.define=function define(name,body){return new Entity(name,body);};function Entity(name,body){this.name=name;this.body=body;this.decoders={};this.encoders={};};Entity.prototype._createNamed=function createNamed(base){var named;try{named=require('vm').runInThisContext('(function '+this.name+'(entity) {\n'+'  this._initNamed(entity);\n'+'})');}catch(e){named=function(entity){this._initNamed(entity);};}
...
throw new Error('Unsupported tag: '+tag);};Node.prototype._isNumstr=function isNumstr(str){return/^[0-9]*$/.test(str);};Node.prototype._isPrintstr=function isPrintstr(str){return/^[A-Za-z0-9'\(\)\+,\-\.\/:=\?]*$/.test(str);
};

},{"../base":51,"minimalistic-assert":178}],53:[function(require,module,exports){
...
},{"inherits":151}],54:[function(require,module,exports){
...
},{"../../asn1":48,"inherits":151}],57:[function(require,module,exports){
...
},{"./der":56,"buffer":97,"inherits":151}],59:[function(require,module,exports){
var inherits = require('inherits');
var Buffer = require('buffer').Buffer;
...
lookup[(tmp>>4)&0x3F]+
lookup[(tmp<<2)&0x3F]+'=')}
return parts.join('')}},{}],63:[function(require,module,exports){(function(module,exports){'use strict';function assert(val,msg){if(!val)throw new Error(msg||'Assertion failed');}
...
return res._forceRed(this);};Mont.prototype.invm=function invm(a){var res=this.imod(a._invmp(this.m).mul(this.r2));return res._forceRed(this);};})(typeof module==='undefined'||module,this);},{"buffer":65}],64:[function(require,module,exports){var r;module.exports=function rand(len){if(!r)
...
throw new Error('Not supported');Rand.prototype._rand=function _rand(n){return crypto.randomBytes(n);};}catch(e){}}},{"crypto":65}],65:[function(require,module,exports){},{}],66:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
...
scrubVec(this._key)}
module.exports.AES=AES},{"safe-buffer":217}],67:[function(require,module,exports){var aes=require('./aes')
...
module.exports=StreamCipher},{"./aes":66,"./ghash":71,"./incr32":72,"buffer-xor":96,"cipher-base":98,"inherits":151,"safe-buffer":217}],68:[function(require,module,exports){var ciphers=require('./encrypter')
...
exports.listCiphers=exports.getCiphers=getCiphers},{"./decrypter":69,"./encrypter":70,"./modes/list.json":80}],69:[function(require,module,exports){var AuthCipher=require('./authCipher')
var Buffer=require('safe-buffer').Buffer
...
exports.createDecipheriv=createDecipheriv},{"./aes":66,"./authCipher":67,"./modes":79,"./streamCipher":82,"cipher-base":98,"evp_bytestokey":135,"inherits":151,"safe-buffer":217}],70:[function(require,module,exports){var MODES=require('./modes')
...
exports.createCipher=createCipher},{"./aes":66,"./authCipher":67,"./modes":79,"./streamCipher":82,"cipher-base":98,"evp_bytestokey":135,"inherits":151,"safe-buffer":217}],71:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
...
return this.state}
module.exports=GHASH},{"safe-buffer":217}],72:[function(require,module,exports){function incr32(iv){var len=iv.length
var item
while(len--){item=iv.readUInt8(len)
if(item===255){iv.writeUInt8(0,len)}else{item++
iv.writeUInt8(item,len)
break}}}
module.exports=incr32},{}],73:[function(require,module,exports){var xor=require('buffer-xor')
...
return xor(out,pad)}},{"buffer-xor":96}],74:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
var xor=require('buffer-xor')
...
break}}
return out}},{"buffer-xor":96,"safe-buffer":217}],75:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
...
return out}},{"safe-buffer":217}],76:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
...
var i=-1
while(++i<len){out[i]=encryptByte(self,chunk[i],decrypt)}
return out}},{"safe-buffer":217}],77:[function(require,module,exports){var xor=require('buffer-xor')
var Buffer=require('safe-buffer').Buffer
var incr32=require('../incr32')
...
return xor(chunk,pad)}},{"../incr32":72,"buffer-xor":96,"safe-buffer":217}],78:[function(require,module,exports){exports.encrypt=function(self,block){return self._cipher.encryptBlock(block)}
exports.decrypt=function(self,block){return self._cipher.decryptBlock(block)}},{}],79:[function(require,module,exports){var modeModules={ECB:require('./ecb'),CBC:require('./cbc'),CFB:require('./cfb'),CFB8:require('./cfb8'),CFB1:require('./cfb1'),OFB:require('./ofb'),CTR:require('./ctr'),GCM:require('./ctr')}
var modes=require('./list.json')
for(var key in modes){modes[key].module=modeModules[modes[key].mode]}
module.exports=modes},{"./cbc":73,"./cfb":74,"./cfb1":75,"./cfb8":76,"./ctr":77,"./ecb":78,"./list.json":80,"./ofb":81}],80:[function(require,module,exports){module.exports={"aes-128-ecb":{"cipher":"AES","key":128,"iv":0,"mode":"ECB","type":"block"},"aes-192-ecb":{"cipher":"AES","key":192,"iv":0,"mode":"ECB","type":"block"},"aes-256-ecb":{"cipher":"AES","key":256,"iv":0,"mode":"ECB","type":"block"},"aes-128-cbc":{"cipher":"AES","key":128,"iv":16,"mode":"CBC","type":"block"},"aes-192-cbc":{"cipher":"AES","key":192,"iv":16,"mode":"CBC","type":"block"},"aes-256-cbc":{"cipher":"AES","key":256,"iv":16,"mode":"CBC","type":"block"},"aes128":{"cipher":"AES","key":128,"iv":16,"mode":"CBC","type":"block"},"aes192":{"cipher":"AES","key":192,"iv":16,"mode":"CBC","type":"block"},"aes256":{"cipher":"AES","key":256,"iv":16,"mode":"CBC","type":"block"},"aes-128-cfb":{"cipher":"AES","key":128,"iv":16,"mode":"CFB","type":"stream"},"aes-192-cfb":{"cipher":"AES","key":192,"iv":16,"mode":"CFB","type":"stream"},"aes-256-cfb":{"cipher":"AES","key":256,"iv":16,"mode":"CFB","type":"stream"},"aes-128-cfb8":{"cipher":"AES","key":128,"iv":16,"mode":"CFB8","type":"stream"},"aes-192-cfb8":{"cipher":"AES","key":192,"iv":16,"mode":"CFB8","type":"stream"},"aes-256-cfb8":{"cipher":"AES","key":256,"iv":16,"mode":"CFB8","type":"stream"},"aes-128-cfb1":{"cipher":"AES","key":128,"iv":16,"mode":"CFB1","type":"stream"},"aes-192-cfb1":{"cipher":"AES","key":192,"iv":16,"mode":"CFB1","type":"stream"},"aes-256-cfb1":{"cipher":"AES","key":256,"iv":16,"mode":"CFB1","type":"stream"},"aes-128-ofb":{"cipher":"AES","key":128,"iv":16,"mode":"OFB","type":"stream"},"aes-192-ofb":{"cipher":"AES","key":192,"iv":16,"mode":"OFB","type":"stream"},"aes-256-ofb":{"cipher":"AES","key":256,"iv":16,"mode":"OFB","type":"stream"},"aes-128-ctr":{"cipher":"AES","key":128,"iv":16,"mode":"CTR","type":"stream"},"aes-192-ctr":{"cipher":"AES","key":192,"iv":16,"mode":"CTR","type":"stream"},"aes-256-ctr":{"cipher":"AES","key":256,"iv":16,"mode":"CTR","type":"stream"},"aes-128-gcm":{"cipher":"AES","key":128,"iv":12,"mode":"GCM","type":"auth"},"aes-192-gcm":{"cipher":"AES","key":192,"iv":12,"mode":"GCM","type":"auth"},"aes-256-gcm":{"cipher":"AES","key":256,"iv":12,"mode":"GCM","type":"auth"}}},{}],81:[function(require,module,exports){(function(Buffer){var xor=require('buffer-xor')
...
var pad=self._cache.slice(0,chunk.length)
self._cache=self._cache.slice(chunk.length)
return xor(chunk,pad)}}).call(this,require("buffer").Buffer)},{"buffer":97,"buffer-xor":96}],82:[function(require,module,exports){var aes=require('./aes')
var Buffer=require('safe-buffer').Buffer
var Transform=require('cipher-base')
var inherits=require('inherits')
function StreamCipher(mode,key,iv,decrypt){Transform.call(this)
...
module.exports=StreamCipher},{"./aes":66,"cipher-base":98,"inherits":151,"safe-buffer":217}],83:[function(require,module,exports){var DES=require('browserify-des')
...
exports.listCiphers=exports.getCiphers=getCiphers},{"browserify-aes/browser":68,"browserify-aes/modes":79,"browserify-des":84,"browserify-des/modes":85,"evp_bytestokey":135}],84:[function(require,module,exports){var CipherBase=require('cipher-base')
...
DES.prototype._final=function(){return Buffer.from(this._des.final())}},{"cipher-base":98,"des.js":106,"inherits":151,"safe-buffer":217}],85:[function(require,module,exports){exports['des-ecb']={key:8,iv:0}
...
return r;}}).call(this,require("buffer").Buffer)},{"bn.js":63,"buffer":97,"randombytes":199}],87:[function(require,module,exports){module.exports=require('./browser/algorithms.json')},{"./browser/algorithms.json":88}],88:[function(require,module,exports){module.exports={"sha224WithRSAEncryption":{"sign":"rsa","hash":"sha224","id":"302d300d06096086480165030402040500041c"},"RSA-SHA224":{"sign":"ecdsa/rsa","hash":"sha224","id":"302d300d06096086480165030402040500041c"},"sha256WithRSAEncryption":{"sign":"rsa","hash":"sha256","id":"3031300d060960864801650304020105000420"},"RSA-SHA256":{"sign":"ecdsa/rsa","hash":"sha256","id":"3031300d060960864801650304020105000420"},"sha384WithRSAEncryption":{"sign":"rsa","hash":"sha384","id":"3041300d060960864801650304020205000430"},"RSA-SHA384":{"sign":"ecdsa/rsa","hash":"sha384","id":"3041300d060960864801650304020205000430"},"sha512WithRSAEncryption":{"sign":"rsa","hash":"sha512","id":"3051300d060960864801650304020305000440"},"RSA-SHA512":{"sign":"ecdsa/rsa","hash":"sha512","id":"3051300d060960864801650304020305000440"},"RSA-SHA1":{"sign":"rsa","hash":"sha1","id":"3021300906052b0e03021a05000414"},"ecdsa-with-SHA1":{"sign":"ecdsa","hash":"sha1","id":""},"sha256":{"sign":"ecdsa","hash":"sha256","id":""},"sha224":{"sign":"ecdsa","hash":"sha224","id":""},"sha384":{"sign":"ecdsa","hash":"sha384","id":""},"sha512":{"sign":"ecdsa","hash":"sha512","id":""},"DSA-SHA":{"sign":"dsa","hash":"sha1","id":""},"DSA-SHA1":{"sign":"dsa","hash":"sha1","id":""},"DSA":{"sign":"dsa","hash":"sha1","id":""},"DSA-WITH-SHA224":{"sign":"dsa","hash":"sha224","id":""},"DSA-SHA224":{"sign":"dsa","hash":"sha224","id":""},"DSA-WITH-SHA256":{"sign":"dsa","hash":"sha256","id":""},"DSA-SHA256":{"sign":"dsa","hash":"sha256","id":""},"DSA-WITH-SHA384":{"sign":"dsa","hash":"sha384","id":""},"DSA-SHA384":{"sign":"dsa","hash":"sha384","id":""},"DSA-WITH-SHA512":{"sign":"dsa","hash":"sha512","id":""},"DSA-SHA512":{"sign":"dsa","hash":"sha512","id":""},"DSA-RIPEMD160":{"sign":"dsa","hash":"rmd160","id":""},"ripemd160WithRSA":{"sign":"rsa","hash":"rmd160","id":"3021300906052b2403020105000414"},"RSA-RIPEMD160":{"sign":"rsa","hash":"rmd160","id":"3021300906052b2403020105000414"},"md5WithRSAEncryption":{"sign":"rsa","hash":"md5","id":"3020300c06082a864886f70d020505000410"},"RSA-MD5":{"sign":"rsa","hash":"md5","id":"3020300c06082a864886f70d020505000410"}}},{}],89:[function(require,module,exports){module.exports={"1.3.132.0.10":"secp256k1","1.3.132.0.33":"p224","1.2.840.10045.3.1.1":"p192","1.2.840.10045.3.1.7":"p256","1.3.132.0.34":"p384","1.3.132.0.35":"p521"}},{}],90:[function(require,module,exports){(function(Buffer){var createHash=require('create-hash')
...
module.exports.makeKey=makeKey}).call(this,require("buffer").Buffer)},{"./curves.json":89,"bn.js":63,"browserify-rsa":86,"buffer":97,"create-hmac":103,"elliptic":118,"parse-asn1":185}],92:[function(require,module,exports){(function(Buffer){var BN=require('bn.js')
var EC=require('elliptic').ec
var parseKeys=require('parse-asn1')
var curves=require('./curves.json')
...
return origin;};function hasOwnProperty(obj,prop){return Object.prototype.hasOwnProperty.call(obj,prop);}}).call(this,require('_process'),typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})},{"./support/isBuffer":93,"_process":192,"inherits":151}],95:[function(require,module,exports){'use strict';var Buffer=require('buffer').Buffer;var SlowBuffer=require('buffer').SlowBuffer;module.exports=bufferEq;function bufferEq(a,b){if(!Buffer.isBuffer(a)||!Buffer.isBuffer(b)){return false;}
if(a.length!==b.length){return false;}
var c=0;for(var i=0;i<a.length;i++){c|=a[i]^b[i];}
return c===0;}
bufferEq.install=function(){Buffer.prototype.equal=SlowBuffer.prototype.equal=function equal(that){return bufferEq(this,that);};};var origBufEqual=Buffer.prototype.equal;var origSlowBufEqual=SlowBuffer.prototype.equal;bufferEq.restore=function(){Buffer.prototype.equal=origBufEqual;SlowBuffer.prototype.equal=origSlowBufEqual;};},{"buffer":97}],96:[function(require,module,exports){(function(Buffer){module.exports=function xor(a,b){var length=Math.min(a.length,b.length)
var buffer=new Buffer(length)
for(var i=0;i<length;++i){buffer[i]=a[i]^b[i]}
return buffer}}).call(this,require("buffer").Buffer)},{"buffer":97}],97:[function(require,module,exports){(function(Buffer){'use strict'
...
function numberIsNaN(obj){return obj!==obj}}).call(this,require("buffer").Buffer)},{"base64-js":62,"buffer":97,"ieee754":150}],98:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
...
return out}
module.exports=CipherBase},{"inherits":151,"safe-buffer":217,"stream":227,"string_decoder":228}],99:[function(require,module,exports){(function(Buffer){function isArray(arg){if(Array.isArray){return Array.isArray(arg);}
...
exports.isError=isError;function isFunction(arg){return typeof arg==='function';}
exports.isFunction=isFunction;function isPrimitive(arg){return arg===null||typeof arg==='boolean'||typeof arg==='number'||typeof arg==='string'||typeof arg==='symbol'||typeof arg==='undefined';}
exports.isPrimitive=isPrimitive;exports.isBuffer=Buffer.isBuffer;function objectToString(o){return Object.prototype.toString.call(o);}}).call(this,{"isBuffer":require("../../is-buffer/index.js")})},{"../../is-buffer/index.js":152}],100:[function(require,module,exports){(function(Buffer){var elliptic=require('elliptic')
var BN=require('bn.js')
...
if(!enc){return buf}else{return buf.toString(enc)}}}).call(this,require("buffer").Buffer)},{"bn.js":63,"buffer":97,"elliptic":118}],101:[function(require,module,exports){'use strict'
var inherits=require('inherits')
...
return new Hash(sha(alg))}},{"cipher-base":98,"inherits":151,"md5.js":176,"ripemd160":216,"sha.js":220}],102:[function(require,module,exports){var MD5=require('md5.js')
module.exports=function(buffer){return new MD5().update(buffer).digest()}},{"md5.js":176}],103:[function(require,module,exports){'use strict'
var inherits=require('inherits')
...
return new Hmac(alg,key)}},{"./legacy":104,"cipher-base":98,"create-hash/md5":102,"inherits":151,"ripemd160":216,"safe-buffer":217,"sha.js":220}],104:[function(require,module,exports){'use strict'
var inherits=require('inherits')
var Buffer=require('safe-buffer').Buffer
var Base=require('cipher-base')
var ZEROS=Buffer.alloc(128)
...
module.exports=Hmac},{"cipher-base":98,"inherits":151,"safe-buffer":217}],105:[function(require,module,exports){'use strict'
...
iv[i]=inp[inOff+i];}};},{"inherits":151,"minimalistic-assert":178}],108:[function(require,module,exports){'use strict';var assert=require('minimalistic-assert');function Cipher(options){this.options=options;this.type=this.options.type;this.blockSize=8;this._init();this.buffer=new Array(this.blockSize);this.bufferOff=0;}
...
var rLength=signature[offset++];if(inputLength-offset-2<rLength){throw new Error('"r" specified length of "'+rLength+'", only "'+(inputLength-offset-2)+'" available');}
...
var rOffset=offset;offset+=rLength;if(signature[offset++]!==ENCODED_TAG_INT){throw new Error('Could not find expected "int" for "s"');}
var sLength=signature[offset++];if(inputLength-offset!==sLength){throw new Error('"s" specified length of "'+sLength+'", expected "'+(inputLength-offset)+'"');}
...
var sOffset=offset;offset+=sLength;if(offset!==inputLength){throw new Error('Expected to consume entire buffer, but "'+(inputLength-offset)+'" bytes remain');}
var rPadding=paramBytes-rLength,sPadding=paramBytes-sLength;var dst=Buffer.allocUnsafe(rPadding+rLength+sPadding+sLength);for(offset=0;offset<rPadding;++offset){dst[offset]=0;}
signature.copy(dst,offset,rOffset+Math.max(-rPadding,0),rOffset+rLength);offset=paramBytes;for(var o=offset;offset<o+sPadding;++offset){dst[offset]=0;}
signature.copy(dst,offset,sOffset+Math.max(-sPadding,0),sOffset+sLength);dst=dst.toString('base64');dst=base64Url(dst);return dst;}
function countPadding(buf,start,stop){var padding=0;while(start+padding<stop&&buf[start+padding]===0){++padding;}
var needsSign=buf[start+padding]>=MAX_OCTET;if(needsSign){--padding;}
return padding;}
function joseToDer(signature,alg){signature=signatureAsBuffer(signature);var paramBytes=getParamBytesForAlg(alg);var signatureBytes=signature.length;if(signatureBytes!==paramBytes*2){throw new TypeError('"'+alg+'" signatures must be "'+paramBytes*2+'" bytes, saw "'+signatureBytes+'"');}
var rPadding=countPadding(signature,0,paramBytes);var sPadding=countPadding(signature,paramBytes,signature.length);var rLength=paramBytes-rPadding;var sLength=paramBytes-sPadding;var rsBytes=1+1+rLength+1+1+sLength;var shortLength=rsBytes<MAX_OCTET;var dst=Buffer.allocUnsafe((shortLength?2:3)+rsBytes);var offset=0;dst[offset++]=ENCODED_TAG_SEQ;if(shortLength){dst[offset++]=rsBytes;}else{dst[offset++]=MAX_OCTET|1;dst[offset++]=rsBytes&0xff;}
dst[offset++]=ENCODED_TAG_INT;dst[offset++]=rLength;if(rPadding<0){dst[offset++]=0;offset+=signature.copy(dst,offset,0,paramBytes);}else{offset+=signature.copy(dst,offset,rPadding,paramBytes);}
dst[offset++]=ENCODED_TAG_INT;dst[offset++]=sLength;if(sPadding<0){dst[offset++]=0;signature.copy(dst,offset,paramBytes);}else{signature.copy(dst,offset,paramBytes+sPadding);}
return dst;}
module.exports={derToJose:derToJose,joseToDer:joseToDer};},{"./param-bytes-for-alg":117,"safe-buffer":217}],117:[function(require,module,exports){'use strict';function getParamSize(keySize){var result=((keySize/8)|0)+(keySize%8===0?0:1);return result;}
var paramBytesForAlg={ES256:getParamSize(256),ES384:getParamSize(384),ES512:getParamSize(521)};function getParamBytesForAlg(alg){var paramBytes=paramBytesForAlg[alg];if(paramBytes){return paramBytes;}
throw new Error('Unknown algorithm "'+alg+'"');}
module.exports=getParamBytesForAlg;},{}],118:[function(require,module,exports){'use strict';var elliptic=exports;elliptic.version=require('../package.json').version;elliptic.utils=require('./elliptic/utils');elliptic.rand=require('brorand');elliptic.curve=require('./elliptic/curve');elliptic.curves=require('./elliptic/curves');elliptic.ec=require('./elliptic/ec');elliptic.eddsa=require('./elliptic/eddsa');},{"../package.json":133,"./elliptic/curve":121,"./elliptic/curves":124,"./elliptic/ec":125,"./elliptic/eddsa":128,"./elliptic/utils":132,"brorand":64}],119:[function(require,module,exports){'use strict';var BN=require('bn.js');var elliptic=require('../../elliptic');var utils=elliptic.utils;var getNAF=utils.getNAF;var getJSF=utils.getJSF;var assert=utils.assert;function BaseCurve(type,conf){this.type=type;this.p=new BN(conf.p,16);this.red=conf.prime?BN.red(conf.prime):BN.mont(this.p);this.zero=new BN(0).toRed(this.red);this.one=new BN(1).toRed(this.red);this.two=new BN(2).toRed(this.red);this.n=conf.n&&new BN(conf.n,16);this.g=conf.g&&this.pointFromJSON(conf.g,conf.gRed);this._wnafT1=new Array(4);this._wnafT2=new Array(4);this._wnafT3=new Array(4);this._wnafT4=new Array(4);var adjustCount=this.n&&this.p.div(this.n);if(!adjustCount||adjustCount.cmpn(100)>0){this.redN=null;}else{this._maxwellTrick=true;this.redN=this.n.toRed(this.red);}}
...
return k;}
function functionBindPolyfill(context){var fn=this;return function(){return fn.apply(context,arguments);};}},{}],135:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
var MD5=require('md5.js')
...
module.exports=EVP_BytesToKey},{"md5.js":176,"safe-buffer":217}],136:[function(require,module,exports){'use strict'
var Buffer=require('safe-buffer').Buffer
var Transform=require('stream').Transform
var inherits=require('inherits')
...
res[i++]=0;}
return res;};},{"./utils":148,"minimalistic-assert":178}],139:[function(require,module,exports){'use strict';var utils=require('./utils');var assert=require('minimalistic-assert');function Hmac(hash,key,enc){if(!(this instanceof Hmac))
...
return utils.split32(this.h,'big');};},{"../common":138,"../utils":148,"./common":147}],143:[function(require,module,exports){'use strict';var utils=require('../utils');var SHA256=require('./256');function SHA224(){if(!(this instanceof SHA224))
...
return utils.toHex32(this.h,'big');else
return utils.split32(this.h,'big');};},{"../common":138,"../utils":148,"./common":147,"minimalistic-assert":178}],145:[function(require,module,exports){'use strict';var utils=require('../utils');var SHA512=require('./512');function SHA384(){if(!(this instanceof SHA384))
...
r+=0x100000000;return r;}},{"../common":138,"../utils":148,"minimalistic-assert":178}],147:[function(require,module,exports){'use strict';var utils=require('../utils');var rotr32=utils.rotr32;function ft_1(s,x,y,z){if(s===0)
...
exports.g1_256=g1_256;},{"../utils":148}],148:[function(require,module,exports){'use strict';var assert=require('minimalistic-assert');var inherits=require('inherits');exports.inherits=inherits;function isSurrogatePair(msg,i){if((msg.charCodeAt(i)&0xFC00)!==0xD800){return false;}
...
exports.shr64_lo=shr64_lo;},{"inherits":151,"minimalistic-assert":178}],149:[function(require,module,exports){'use strict';var hash=require('hash.js');var utils=require('minimalistic-crypto-utils');var assert=require('minimalistic-assert');function HmacDRBG(options){if(!(this instanceof HmacDRBG))
...
var res=temp.slice(0,len);this._update(add);this._reseed++;return utils.encode(res,enc);};},{"hash.js":137,"minimalistic-assert":178,"minimalistic-crypto-utils":179}],150:[function(require,module,exports){exports.read=function(buffer,offset,isLE,mLen,nBytes){var e,m
...
buffer[offset+i-d]|=s*128}},{}],151:[function(require,module,exports){if(typeof Object.create==='function'){module.exports=function inherits(ctor,superCtor){ctor.super_=superCtor
ctor.prototype=Object.create(superCtor.prototype,{constructor:{value:ctor,enumerable:false,writable:true,configurable:true}});};}else{module.exports=function inherits(ctor,superCtor){ctor.super_=superCtor
var TempCtor=function(){}
TempCtor.prototype=superCtor.prototype
ctor.prototype=new TempCtor()
ctor.prototype.constructor=ctor}}},{}],152:[function(require,module,exports){module.exports=function(obj){return obj!=null&&(isBuffer(obj)||isSlowBuffer(obj)||!!obj._isBuffer)}
function isBuffer(obj){return!!obj.constructor&&typeof obj.constructor.isBuffer==='function'&&obj.constructor.isBuffer(obj)}
function isSlowBuffer(obj){return typeof obj.readFloatLE==='function'&&typeof obj.slice==='function'&&isBuffer(obj.slice(0,0))}},{}],153:[function(require,module,exports){var jws=require('jws');module.exports=function(jwt,options){options=options||{};var decoded=jws.decode(jwt,options);if(!decoded){return null;}
var payload=decoded.payload;if(typeof payload==='string'){try{var obj=JSON.parse(payload);if(obj!==null&&typeof obj==='object'){payload=obj;}}catch(e){}}
if(options.complete===true){return{header:decoded.header,payload:payload,signature:decoded.signature};}
return payload;};},{"jws":164}],154:[function(require,module,exports){module.exports={decode:require('./decode'),verify:require('./verify'),sign:require('./sign'),JsonWebTokenError:require('./lib/JsonWebTokenError'),NotBeforeError:require('./lib/NotBeforeError'),TokenExpiredError:require('./lib/TokenExpiredError'),};},{"./decode":153,"./lib/JsonWebTokenError":155,"./lib/NotBeforeError":156,"./lib/TokenExpiredError":157,"./sign":161,"./verify":162}],155:[function(require,module,exports){var JsonWebTokenError=function(message,error){Error.call(this,message);if(Error.captureStackTrace){Error.captureStackTrace(this,this.constructor);}
this.name='JsonWebTokenError';this.message=message;if(error)this.inner=error;};JsonWebTokenError.prototype=Object.create(Error.prototype);JsonWebTokenError.prototype.constructor=JsonWebTokenError;module.exports=JsonWebTokenError;},{}],156:[function(require,module,exports){var JsonWebTokenError=require('./JsonWebTokenError');var NotBeforeError=function(message,date){JsonWebTokenError.call(this,message);this.name='NotBeforeError';this.date=date;};NotBeforeError.prototype=Object.create(JsonWebTokenError.prototype);NotBeforeError.prototype.constructor=NotBeforeError;module.exports=NotBeforeError;},{"./JsonWebTokenError":155}],157:[function(require,module,exports){var JsonWebTokenError=require('./JsonWebTokenError');var TokenExpiredError=function(message,expiredAt){JsonWebTokenError.call(this,message);this.name='TokenExpiredError';this.expiredAt=expiredAt;};TokenExpiredError.prototype=Object.create(JsonWebTokenError.prototype);TokenExpiredError.prototype.constructor=TokenExpiredError;module.exports=TokenExpiredError;},{"./JsonWebTokenError":155}],158:[function(require,module,exports){(function(process){var semver=require('semver');module.exports=semver.satisfies(process.version,'^6.12.0 || >=8.0.0');}).call(this,require('_process'))},{"_process":192,"semver":218}],159:[function(require,module,exports){var ms=require('ms');module.exports=function(time,iat){var timestamp=iat||Math.floor(Date.now()/1000);if(typeof time==='string'){var milliseconds=ms(time);if(typeof milliseconds==='undefined'){return;}
return Math.floor(timestamp+milliseconds/1000);}else if(typeof time==='number'){return timestamp+time;}else{return;}};},{"ms":160}],160:[function(require,module,exports){var s=1000;var m=s*60;var h=m*60;var d=h*24;var w=d*7;var y=d*365.25;module.exports=function(val,options){options=options||{};var type=typeof val;if(type==='string'&&val.length>0){return parse(val);}else if(type==='number'&&isNaN(val)===false){return options.long?fmtLong(val):fmtShort(val);}
...
return ms+' ms';}
function plural(ms,msAbs,n,name){var isPlural=msAbs>=n*1.5;return Math.round(ms/n)+' '+name+(isPlural?'s':'');}},{}],161:[function(require,module,exports){(function(Buffer){var timespan=require('./lib/timespan');var PS_SUPPORTED=require('./lib/psSupported');var jws=require('jws');var includes=require('lodash.includes');var isBoolean=require('lodash.isboolean');var isInteger=require('lodash.isinteger');var isNumber=require('lodash.isnumber');var isPlainObject=require('lodash.isplainobject');var isString=require('lodash.isstring');var once=require('lodash.once');var SUPPORTED_ALGS=['RS256','RS384','RS512','ES256','ES384','ES512','HS256','HS384','HS512','none']
if(PS_SUPPORTED){SUPPORTED_ALGS.splice(3,0,'PS256','PS384','PS512');}
var sign_options_schema={expiresIn:{isValid:function(value){return isInteger(value)||(isString(value)&&value);},message:'"expiresIn" should be a number of seconds or string representing a timespan'},notBefore:{isValid:function(value){return isInteger(value)||(isString(value)&&value);},message:'"notBefore" should be a number of seconds or string representing a timespan'},audience:{isValid:function(value){return isString(value)||Array.isArray(value);},message:'"audience" must be a string or array'},algorithm:{isValid:includes.bind(null,SUPPORTED_ALGS),message:'"algorithm" must be a valid string enum value'},header:{isValid:isPlainObject,message:'"header" must be an object'},encoding:{isValid:isString,message:'"encoding" must be a string'},issuer:{isValid:isString,message:'"issuer" must be a string'},subject:{isValid:isString,message:'"subject" must be a string'},jwtid:{isValid:isString,message:'"jwtid" must be a string'},noTimestamp:{isValid:isBoolean,message:'"noTimestamp" must be a boolean'},keyid:{isValid:isString,message:'"keyid" must be a string'},mutatePayload:{isValid:isBoolean,message:'"mutatePayload" must be a boolean'}};var registered_claims_schema={iat:{isValid:isNumber,message:'"iat" should be a number of seconds'},exp:{isValid:isNumber,message:'"exp" should be a number of seconds'},nbf:{isValid:isNumber,message:'"nbf" should be a number of seconds'}};function validate(schema,allowUnknown,object,parameterName){if(!isPlainObject(object)){throw new Error('Expected "'+parameterName+'" to be a plain object.');}
Object.keys(object).forEach(function(key){var validator=schema[key];if(!validator){if(!allowUnknown){throw new Error('"'+key+'" is not allowed in "'+parameterName+'"');}
return;}
if(!validator.isValid(object[key])){throw new Error(validator.message);}});}
function validateOptions(options){return validate(sign_options_schema,false,options,'options');}
function validatePayload(payload){return validate(registered_claims_schema,true,payload,'payload');}
var options_to_payload={'audience':'aud','issuer':'iss','subject':'sub','jwtid':'jti'};var options_for_objects=['expiresIn','notBefore','noTimestamp','audience','issuer','subject','jwtid',];module.exports=function(payload,secretOrPrivateKey,options,callback){if(typeof options==='function'){callback=options;options={};}else{options=options||{};}
var isObjectPayload=typeof payload==='object'&&!Buffer.isBuffer(payload);var header=Object.assign({alg:options.algorithm||'HS256',typ:isObjectPayload?'JWT':undefined,kid:options.keyid},options.header);function failure(err){if(callback){return callback(err);}
throw err;}
if(!secretOrPrivateKey&&options.algorithm!=='none'){return failure(new Error('secretOrPrivateKey must have a value'));}
if(typeof payload==='undefined'){return failure(new Error('payload is required'));}else if(isObjectPayload){try{validatePayload(payload);}
catch(error){return failure(error);}
if(!options.mutatePayload){payload=Object.assign({},payload);}}else{var invalid_options=options_for_objects.filter(function(opt){return typeof options[opt]!=='undefined';});if(invalid_options.length>0){return failure(new Error('invalid '+invalid_options.join(',')+' option for '+(typeof payload)+' payload'));}}
...
var timestamp=payload.iat||Math.floor(Date.now()/1000);if(options.noTimestamp){delete payload.iat;}else if(isObjectPayload){payload.iat=timestamp;}
if(typeof options.notBefore!=='undefined'){try{payload.nbf=timespan(options.notBefore,timestamp);}
...
if(typeof options.expiresIn!=='undefined'&&typeof payload==='object'){try{payload.exp=timespan(options.expiresIn,timestamp);}
catch(err){return failure(err);}
...
Object.keys(options_to_payload).forEach(function(key){var claim=options_to_payload[key];if(typeof options[key]!=='undefined'){if(typeof payload[claim]!=='undefined'){return failure(new Error('Bad "options.'+key+'" option. The payload already has an "'+claim+'" property.'));}
payload[claim]=options[key];}});var encoding=options.encoding||'utf8';if(typeof callback==='function'){callback=callback&&once(callback);jws.createSign({header:header,privateKey:secretOrPrivateKey,payload:payload,encoding:encoding}).once('error',callback).once('done',function(signature){callback(null,signature);});}else{return jws.sign({header:header,payload:payload,secret:secretOrPrivateKey,encoding:encoding});}};}).call(this,{"isBuffer":require("../is-buffer/index.js")})},{"../is-buffer/index.js":152,"./lib/psSupported":158,"./lib/timespan":159,"jws":164,"lodash.includes":169,"lodash.isboolean":170,"lodash.isinteger":171,"lodash.isnumber":172,"lodash.isplainobject":173,"lodash.isstring":174,"lodash.once":175}],162:[function(require,module,exports){var JsonWebTokenError=require('./lib/JsonWebTokenError');var NotBeforeError=require('./lib/NotBeforeError');var TokenExpiredError=require('./lib/TokenExpiredError');var decode=require('./decode');var timespan=require('./lib/timespan');var PS_SUPPORTED=require('./lib/psSupported');var jws=require('jws');var PUB_KEY_ALGS=['RS256','RS384','RS512','ES256','ES384','ES512'];var RSA_KEY_ALGS=['RS256','RS384','RS512'];var HS_ALGS=['HS256','HS384','HS512'];if(PS_SUPPORTED){PUB_KEY_ALGS.splice(3,0,'PS256','PS384','PS512');RSA_KEY_ALGS.splice(3,0,'PS256','PS384','PS512');}
module.exports=function(jwtString,secretOrPublicKey,options,callback){if((typeof options==='function')&&!callback){callback=options;options={};}
if(!options){options={};}
options=Object.assign({},options);var done;if(callback){done=callback;}else{done=function(err,data){if(err)throw err;return data;};}
...
if(options.nonce!==undefined&&(typeof options.nonce!=='string'||options.nonce.trim()==='')){return done(new JsonWebTokenError('nonce must be a non-empty string'));}
var clockTimestamp=options.clockTimestamp||Math.floor(Date.now()/1000);if(!jwtString){return done(new JsonWebTokenError('jwt must be provided'));}
...
var decodedToken;try{decodedToken=decode(jwtString,{complete:true});}catch(err){return done(err);}
if(!decodedToken){return done(new JsonWebTokenError('invalid token'));}
var header=decodedToken.header;var getSecret;if(typeof secretOrPublicKey==='function'){if(!callback){return done(new JsonWebTokenError('verify must be called asynchronous if secret or public key is provided as a callback'));}
getSecret=secretOrPublicKey;}
else{getSecret=function(header,secretCallback){return secretCallback(null,secretOrPublicKey);};}
return getSecret(header,function(err,secretOrPublicKey){if(err){return done(new JsonWebTokenError('error in secret or public key callback: '+err.message));}
var hasSignature=parts[2].trim()!=='';if(!hasSignature&&secretOrPublicKey){return done(new JsonWebTokenError('jwt signature is required'));}
if(hasSignature&&!secretOrPublicKey){return done(new JsonWebTokenError('secret or public key must be provided'));}
if(!hasSignature&&!options.algorithms){options.algorithms=['none'];}
if(!options.algorithms){options.algorithms=~secretOrPublicKey.toString().indexOf('BEGIN CERTIFICATE')||~secretOrPublicKey.toString().indexOf('BEGIN PUBLIC KEY')?PUB_KEY_ALGS:~secretOrPublicKey.toString().indexOf('BEGIN RSA PUBLIC KEY')?RSA_KEY_ALGS:HS_ALGS;}
if(!~options.algorithms.indexOf(decodedToken.header.alg)){return done(new JsonWebTokenError('invalid algorithm'));}
var valid;try{valid=jws.verify(jwtString,decodedToken.header.alg,secretOrPublicKey);}catch(e){return done(e);}
if(!valid){return done(new JsonWebTokenError('invalid signature'));}
var payload=decodedToken.payload;if(typeof payload.nbf!=='undefined'&&!options.ignoreNotBefore){if(typeof payload.nbf!=='number'){return done(new JsonWebTokenError('invalid nbf value'));}
if(payload.nbf>clockTimestamp+(options.clockTolerance||0)){return done(new NotBeforeError('jwt not active',new Date(payload.nbf*1000)));}}
if(typeof payload.exp!=='undefined'&&!options.ignoreExpiration){if(typeof payload.exp!=='number'){return done(new JsonWebTokenError('invalid exp value'));}
if(clockTimestamp>=payload.exp+(options.clockTolerance||0)){return done(new TokenExpiredError('jwt expired',new Date(payload.exp*1000)));}}
if(options.audience){var audiences=Array.isArray(options.audience)?options.audience:[options.audience];var target=Array.isArray(payload.aud)?payload.aud:[payload.aud];var match=target.some(function(targetAudience){return audiences.some(function(audience){return audience instanceof RegExp?audience.test(targetAudience):audience===targetAudience;});});if(!match){return done(new JsonWebTokenError('jwt audience invalid. expected: '+audiences.join(' or ')));}}
if(options.issuer){var invalid_issuer=(typeof options.issuer==='string'&&payload.iss!==options.issuer)||(Array.isArray(options.issuer)&&options.issuer.indexOf(payload.iss)===-1);if(invalid_issuer){return done(new JsonWebTokenError('jwt issuer invalid. expected: '+options.issuer));}}
if(options.subject){if(payload.sub!==options.subject){return done(new JsonWebTokenError('jwt subject invalid. expected: '+options.subject));}}
if(options.jwtid){if(payload.jti!==options.jwtid){return done(new JsonWebTokenError('jwt jwtid invalid. expected: '+options.jwtid));}}
if(options.nonce){if(payload.nonce!==options.nonce){return done(new JsonWebTokenError('jwt nonce invalid. expected: '+options.nonce));}}
if(options.maxAge){if(typeof payload.iat!=='number'){return done(new JsonWebTokenError('iat required when maxAge is specified'));}
var maxAgeTimestamp=timespan(options.maxAge,payload.iat);if(typeof maxAgeTimestamp==='undefined'){return done(new JsonWebTokenError('"maxAge" should be a number of seconds or string representing a timespan eg: "1d", "20h", 60'));}
if(clockTimestamp>=maxAgeTimestamp+(options.clockTolerance||0)){return done(new TokenExpiredError('maxAge exceeded',new Date(maxAgeTimestamp*1000)));}}
if(options.complete===true){var signature=decodedToken.signature;return done(null,{header:header,payload:payload,signature:signature});}
return done(null,payload);});};},{"./decode":153,"./lib/JsonWebTokenError":155,"./lib/NotBeforeError":156,"./lib/TokenExpiredError":157,"./lib/psSupported":158,"./lib/timespan":159,"jws":164}],163:[function(require,module,exports){var bufferEqual=require('buffer-equal-constant-time');var Buffer=require('safe-buffer').Buffer;var crypto=require('crypto');var formatEcdsa=require('ecdsa-sig-formatter');var util=require('util');var MSG_INVALID_ALGORITHM='"%s" is not a valid algorithm.\n  Supported algorithms are:\n  "HS256", "HS384", "HS512", "RS256", "RS384", "RS512", "PS256", "PS384", "PS512", "ES256", "ES384", "ES512" and "none".'
var MSG_INVALID_SECRET='secret must be a string or buffer';var MSG_INVALID_VERIFIER_KEY='key must be a string or a buffer';var MSG_INVALID_SIGNER_KEY='key must be a string, a buffer or an object';var supportsKeyObjects=typeof crypto.createPublicKey==='function';if(supportsKeyObjects){MSG_INVALID_VERIFIER_KEY+=' or a KeyObject';MSG_INVALID_SECRET+='or a KeyObject';}
function checkIsPublicKey(key){if(Buffer.isBuffer(key)){return;}
...
if(typeof key.export!=='function'){throw typeError(MSG_INVALID_VERIFIER_KEY);}};function checkIsPrivateKey(key){if(Buffer.isBuffer(key)){return;}
if(typeof key==='string'){return;}
if(typeof key==='object'){return;}
throw typeError(MSG_INVALID_SIGNER_KEY);};function checkIsSecretKey(key){if(Buffer.isBuffer(key)){return;}
...
function toBase64(base64url){base64url=base64url.toString();var padding=4-base64url.length%4;if(padding!==4){for(var i=0;i<padding;++i){base64url+='=';}}
...
function bufferOrString(obj){return Buffer.isBuffer(obj)||typeof obj==='string';}
function normalizeInput(thing){if(!bufferOrString(thing))
thing=JSON.stringify(thing);return thing;}
function createHmacSigner(bits){return function sign(thing,secret){checkIsSecretKey(secret);thing=normalizeInput(thing);var hmac=crypto.createHmac('sha'+bits,secret);var sig=(hmac.update(thing),hmac.digest('base64'))
return fromBase64(sig);}}
function createHmacVerifier(bits){return function verify(thing,signature,secret){var computedSig=createHmacSigner(bits)(thing,secret);return bufferEqual(Buffer.from(signature),Buffer.from(computedSig));}}
function createKeySigner(bits){return function sign(thing,privateKey){checkIsPrivateKey(privateKey);thing=normalizeInput(thing);var signer=crypto.createSign('RSA-SHA'+bits);var sig=(signer.update(thing),signer.sign(privateKey,'base64'));return fromBase64(sig);}}
function createKeyVerifier(bits){return function verify(thing,signature,publicKey){checkIsPublicKey(publicKey);thing=normalizeInput(thing);signature=toBase64(signature);var verifier=crypto.createVerify('RSA-SHA'+bits);verifier.update(thing);return verifier.verify(publicKey,signature,'base64');}}
function createPSSKeySigner(bits){return function sign(thing,privateKey){checkIsPrivateKey(privateKey);thing=normalizeInput(thing);var signer=crypto.createSign('RSA-SHA'+bits);var sig=(signer.update(thing),signer.sign({key:privateKey,padding:crypto.constants.RSA_PKCS1_PSS_PADDING,saltLength:crypto.constants.RSA_PSS_SALTLEN_DIGEST},'base64'));return fromBase64(sig);}}
function createPSSKeyVerifier(bits){return function verify(thing,signature,publicKey){checkIsPublicKey(publicKey);thing=normalizeInput(thing);signature=toBase64(signature);var verifier=crypto.createVerify('RSA-SHA'+bits);verifier.update(thing);return verifier.verify({key:publicKey,padding:crypto.constants.RSA_PKCS1_PSS_PADDING,saltLength:crypto.constants.RSA_PSS_SALTLEN_DIGEST},signature,'base64');}}
function createECDSASigner(bits){var inner=createKeySigner(bits);return function sign(){var signature=inner.apply(null,arguments);signature=formatEcdsa.derToJose(signature,'ES'+bits);return signature;};}
function createECDSAVerifer(bits){var inner=createKeyVerifier(bits);return function verify(thing,signature,publicKey){signature=formatEcdsa.joseToDer(signature,'ES'+bits).toString('base64');var result=inner(thing,signature,publicKey);return result;};}
function createNoneSigner(){return function sign(){return'';}}
function createNoneVerifier(){return function verify(thing,signature){return signature==='';}}
module.exports=function jwa(algorithm){var signerFactories={hs:createHmacSigner,rs:createKeySigner,ps:createPSSKeySigner,es:createECDSASigner,none:createNoneSigner,}
var verifierFactories={hs:createHmacVerifier,rs:createKeyVerifier,ps:createPSSKeyVerifier,es:createECDSAVerifer,none:createNoneVerifier,}
var match=algorithm.match(/^(RS|PS|ES|HS)(256|384|512)$|^(none)$/i);if(!match)
throw typeError(MSG_INVALID_ALGORITHM,algorithm);var algo=(match[1]||match[3]).toLowerCase();var bits=match[2];return{sign:signerFactories[algo](bits),verify:verifierFactories[algo](bits),}};},{"buffer-equal-constant-time":95,"crypto":105,"ecdsa-sig-formatter":116,"safe-buffer":217,"util":94}],164:[function(require,module,exports){var SignStream=require('./lib/sign-stream');var VerifyStream=require('./lib/verify-stream');var ALGORITHMS=['HS256','HS384','HS512','RS256','RS384','RS512','PS256','PS384','PS512','ES256','ES384','ES512'];exports.ALGORITHMS=ALGORITHMS;exports.sign=SignStream.sign;exports.verify=VerifyStream.verify;exports.decode=VerifyStream.decode;exports.isValid=VerifyStream.isValid;exports.createSign=function createSign(opts){return new SignStream(opts);};exports.createVerify=function createVerify(opts){return new VerifyStream(opts);};},{"./lib/sign-stream":166,"./lib/verify-stream":168}],165:[function(require,module,exports){(function(process){var Buffer=require('safe-buffer').Buffer;var Stream=require('stream');var util=require('util');function DataStream(data){this.buffer=null;this.writable=true;this.readable=true;if(!data){this.buffer=Buffer.alloc(0);return this;}
if(typeof data.pipe==='function'){this.buffer=Buffer.alloc(0);data.pipe(this);return this;}
if(data.length||typeof data==='object'){this.buffer=data;this.writable=false;process.nextTick(function(){this.emit('end',data);this.readable=false;this.emit('close');}.bind(this));return this;}
throw new TypeError('Unexpected data type ('+typeof data+')');}
util.inherits(DataStream,Stream);DataStream.prototype.write=function write(data){this.buffer=Buffer.concat([this.buffer,Buffer.from(data)]);this.emit('data',data);};DataStream.prototype.end=function end(data){if(data)
this.write(data);this.emit('end',data);this.emit('close');this.writable=false;this.readable=false;};module.exports=DataStream;}).call(this,require('_process'))},{"_process":192,"safe-buffer":217,"stream":227,"util":94}],166:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer;var DataStream=require('./data-stream');var jwa=require('jwa');var Stream=require('stream');var toString=require('./tostring');var util=require('util');function base64url(string,encoding){return Buffer.from(string,encoding).toString('base64').replace(/=/g,'').replace(/\+/g,'-').replace(/\//g,'_');}
function jwsSecuredInput(header,payload,encoding){encoding=encoding||'utf8';var encodedHeader=base64url(toString(header),'binary');var encodedPayload=base64url(toString(payload),encoding);return util.format('%s.%s',encodedHeader,encodedPayload);}
function jwsSign(opts){var header=opts.header;var payload=opts.payload;var secretOrKey=opts.secret||opts.privateKey;var encoding=opts.encoding;var algo=jwa(header.alg);var securedInput=jwsSecuredInput(header,payload,encoding);var signature=algo.sign(securedInput,secretOrKey);return util.format('%s.%s',securedInput,signature);}
function SignStream(opts){var secret=opts.secret||opts.privateKey||opts.key;var secretStream=new DataStream(secret);this.readable=true;this.header=opts.header;this.encoding=opts.encoding;this.secret=this.privateKey=this.key=secretStream;this.payload=new DataStream(opts.payload);this.secret.once('close',function(){if(!this.payload.writable&&this.readable)
this.sign();}.bind(this));this.payload.once('close',function(){if(!this.secret.writable&&this.readable)
this.sign();}.bind(this));}
util.inherits(SignStream,Stream);SignStream.prototype.sign=function sign(){try{var signature=jwsSign({header:this.header,payload:this.payload.buffer,secret:this.secret.buffer,encoding:this.encoding});this.emit('done',signature);this.emit('data',signature);this.emit('end');this.readable=false;return signature;}catch(e){this.readable=false;this.emit('error',e);this.emit('close');}};SignStream.sign=jwsSign;module.exports=SignStream;},{"./data-stream":165,"./tostring":167,"jwa":163,"safe-buffer":217,"stream":227,"util":94}],167:[function(require,module,exports){var Buffer=require('buffer').Buffer;module.exports=function toString(obj){if(typeof obj==='string')
return obj;if(typeof obj==='number'||Buffer.isBuffer(obj))
return obj.toString();return JSON.stringify(obj);};},{"buffer":97}],168:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer;var DataStream=require('./data-stream');var jwa=require('jwa');var Stream=require('stream');var toString=require('./tostring');var util=require('util');var JWS_REGEX=/^[a-zA-Z0-9\-_]+?\.[a-zA-Z0-9\-_]+?\.([a-zA-Z0-9\-_]+)?$/;function isObject(thing){return Object.prototype.toString.call(thing)==='[object Object]';}
function safeJsonParse(thing){if(isObject(thing))
return thing;try{return JSON.parse(thing);}
...
function jwsVerify(jwsSig,algorithm,secretOrKey){if(!algorithm){var err=new Error("Missing algorithm parameter for jws.verify");err.code="MISSING_ALGORITHM";throw err;}
jwsSig=toString(jwsSig);var signature=signatureFromJWS(jwsSig);var securedInput=securedInputFromJWS(jwsSig);var algo=jwa(algorithm);return algo.verify(securedInput,signature,secretOrKey);}
function jwsDecode(jwsSig,opts){opts=opts||{};jwsSig=toString(jwsSig);if(!isValidJws(jwsSig))
return null;var header=headerFromJWS(jwsSig);if(!header)
return null;var payload=payloadFromJWS(jwsSig);if(header.typ==='JWT'||opts.json)
payload=JSON.parse(payload,opts.encoding);return{header:header,payload:payload,signature:signatureFromJWS(jwsSig)};}
function VerifyStream(opts){opts=opts||{};var secretOrKey=opts.secret||opts.publicKey||opts.key;var secretStream=new DataStream(secretOrKey);this.readable=true;this.algorithm=opts.algorithm;this.encoding=opts.encoding;this.secret=this.publicKey=this.key=secretStream;this.signature=new DataStream(opts.signature);this.secret.once('close',function(){if(!this.signature.writable&&this.readable)
this.verify();}.bind(this));this.signature.once('close',function(){if(!this.secret.writable&&this.readable)
this.verify();}.bind(this));}
util.inherits(VerifyStream,Stream);VerifyStream.prototype.verify=function verify(){try{var valid=jwsVerify(this.signature.buffer,this.algorithm,this.key.buffer);var obj=jwsDecode(this.signature.buffer,this.encoding);this.emit('done',valid,obj);this.emit('data',valid);this.emit('end');this.readable=false;return valid;}catch(e){this.readable=false;this.emit('error',e);this.emit('close');}};VerifyStream.decode=jwsDecode;VerifyStream.isValid=isValidJws;VerifyStream.verify=jwsVerify;module.exports=VerifyStream;},{"./data-stream":165,"./tostring":167,"jwa":163,"safe-buffer":217,"stream":227,"util":94}],169:[function(require,module,exports){var INFINITY=1/0,MAX_SAFE_INTEGER=9007199254740991,MAX_INTEGER=1.7976931348623157e+308,NAN=0/0;var argsTag='[object Arguments]',funcTag='[object Function]',genTag='[object GeneratorFunction]',stringTag='[object String]',symbolTag='[object Symbol]';var reTrim=/^\s+|\s+$/g;var reIsBadHex=/^[-+]0x[0-9a-f]+$/i;var reIsBinary=/^0b[01]+$/i;var reIsOctal=/^0o[0-7]+$/i;var reIsUint=/^(?:0|[1-9]\d*)$/;var freeParseInt=parseInt;function arrayMap(array,iteratee){var index=-1,length=array?array.length:0,result=Array(length);while(++index<length){result[index]=iteratee(array[index],index,array);}
return result;}
...
module.exports=includes;},{}],170:[function(require,module,exports){var boolTag='[object Boolean]';var objectProto=Object.prototype;var objectToString=objectProto.toString;function isBoolean(value){return value===true||value===false||(isObjectLike(value)&&objectToString.call(value)==boolTag);}
function isObjectLike(value){return!!value&&typeof value=='object';}
module.exports=isBoolean;},{}],171:[function(require,module,exports){var INFINITY=1/0,MAX_INTEGER=1.7976931348623157e+308,NAN=0/0;var symbolTag='[object Symbol]';var reTrim=/^\s+|\s+$/g;var reIsBadHex=/^[-+]0x[0-9a-f]+$/i;var reIsBinary=/^0b[01]+$/i;var reIsOctal=/^0o[0-7]+$/i;var freeParseInt=parseInt;var objectProto=Object.prototype;var objectToString=objectProto.toString;function isInteger(value){return typeof value=='number'&&value==toInteger(value);}
function isObject(value){var type=typeof value;return!!value&&(type=='object'||type=='function');}
function isObjectLike(value){return!!value&&typeof value=='object';}
function isSymbol(value){return typeof value=='symbol'||(isObjectLike(value)&&objectToString.call(value)==symbolTag);}
function toFinite(value){if(!value){return value===0?value:0;}
...
if(typeof value!='string'){return value===0?value:+value;}
value=value.replace(reTrim,'');var isBinary=reIsBinary.test(value);return(isBinary||reIsOctal.test(value))?freeParseInt(value.slice(2),isBinary?2:8):(reIsBadHex.test(value)?NAN:+value);}
module.exports=isInteger;},{}],172:[function(require,module,exports){var numberTag='[object Number]';var objectProto=Object.prototype;var objectToString=objectProto.toString;function isObjectLike(value){return!!value&&typeof value=='object';}
function isNumber(value){return typeof value=='number'||(isObjectLike(value)&&objectToString.call(value)==numberTag);}
module.exports=isNumber;},{}],173:[function(require,module,exports){var objectTag='[object Object]';function isHostObject(value){var result=false;if(value!=null&&typeof value.toString!='function'){try{result=!!(value+'');}catch(e){}}
return result;}
function overArg(func,transform){return function(arg){return func(transform(arg));};}
...
module.exports=isPlainObject;},{}],174:[function(require,module,exports){var stringTag='[object String]';var objectProto=Object.prototype;var objectToString=objectProto.toString;var isArray=Array.isArray;function isObjectLike(value){return!!value&&typeof value=='object';}
function isString(value){return typeof value=='string'||(!isArray(value)&&isObjectLike(value)&&objectToString.call(value)==stringTag);}
module.exports=isString;},{}],175:[function(require,module,exports){var FUNC_ERROR_TEXT='Expected a function';var INFINITY=1/0,MAX_INTEGER=1.7976931348623157e+308,NAN=0/0;var symbolTag='[object Symbol]';var reTrim=/^\s+|\s+$/g;var reIsBadHex=/^[-+]0x[0-9a-f]+$/i;var reIsBinary=/^0b[01]+$/i;var reIsOctal=/^0o[0-7]+$/i;var freeParseInt=parseInt;var objectProto=Object.prototype;var objectToString=objectProto.toString;function before(n,func){var result;if(typeof func!='function'){throw new TypeError(FUNC_ERROR_TEXT);}
...
if(typeof value!='string'){return value===0?value:+value;}
value=value.replace(reTrim,'');var isBinary=reIsBinary.test(value);return(isBinary||reIsOctal.test(value))?freeParseInt(value.slice(2),isBinary?2:8):(reIsBadHex.test(value)?NAN:+value);}
module.exports=once;},{}],176:[function(require,module,exports){'use strict'
var inherits=require('inherits')
...
module.exports=MD5},{"hash-base":136,"inherits":151,"safe-buffer":217}],177:[function(require,module,exports){var bn=require('bn.js');var brorand=require('brorand');function MillerRabin(rand){this.rand=rand||new brorand.Rand();}
...
return false;};},{"bn.js":63,"brorand":64}],178:[function(require,module,exports){module.exports=assert;function assert(val,msg){if(!val)
throw new Error(msg||'Assertion failed');}
assert.equal=function assertEqual(l,r,msg){if(l!=r)
throw new Error(msg||('Assertion failed: '+l+' != '+r));};},{}],179:[function(require,module,exports){'use strict';var utils=exports;function toArray(msg,enc){if(Array.isArray(msg))
return msg.slice();if(!msg)
...
return arr;};},{}],180:[function(require,module,exports){var methods="assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,markTimeline,profile,profileEnd,time,timeEnd,trace,warn".split(",");var l=methods.length;var fn=function(){};var mockconsole={};while(l--){mockconsole[methods[l]]=fn;}
module.exports=mockconsole;},{}],181:[function(require,module,exports){module.exports={"2.16.840.1.101.3.4.1.1":"aes-128-ecb","2.16.840.1.101.3.4.1.2":"aes-128-cbc","2.16.840.1.101.3.4.1.3":"aes-128-ofb","2.16.840.1.101.3.4.1.4":"aes-128-cfb","2.16.840.1.101.3.4.1.21":"aes-192-ecb","2.16.840.1.101.3.4.1.22":"aes-192-cbc","2.16.840.1.101.3.4.1.23":"aes-192-ofb","2.16.840.1.101.3.4.1.24":"aes-192-cfb","2.16.840.1.101.3.4.1.41":"aes-256-ecb","2.16.840.1.101.3.4.1.42":"aes-256-cbc","2.16.840.1.101.3.4.1.43":"aes-256-ofb","2.16.840.1.101.3.4.1.44":"aes-256-cfb"}},{}],182:[function(require,module,exports){'use strict'
...
exports.signature=asn1.define('signature',function(){this.seq().obj(this.key('r').int(),this.key('s').int())})},{"./certificate":183,"asn1.js":48}],183:[function(require,module,exports){'use strict'
...
module.exports=X509Certificate},{"asn1.js":48}],184:[function(require,module,exports){var findProc=/Proc-Type: 4,ENCRYPTED[\n\r]+DEK-Info: AES-((?:128)|(?:192)|(?:256))-CBC,([0-9A-H]+)[\n\r]+([0-9A-z\n\r\+\/\=]+)[\n\r]+/m
...
return{tag:tag,data:decrypted}}},{"browserify-aes":68,"evp_bytestokey":135,"safe-buffer":217}],185:[function(require,module,exports){var asn1=require('./asn1')
...
out.push(cipher.update(cipherText))
out.push(cipher.final())
return Buffer.concat(out)}},{"./aesid.json":181,"./asn1":182,"./fixProc":184,"browserify-aes":68,"pbkdf2":186,"safe-buffer":217}],186:[function(require,module,exports){exports.pbkdf2=require('./lib/async')
exports.pbkdf2Sync=require('./lib/sync')},{"./lib/async":187,"./lib/sync":190}],187:[function(require,module,exports){(function(process,global){var checkParameters=require('./precondition')
...
return sync(password,salt,iterations,keylen,digest)}),callback)}}).call(this,require('_process'),typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})},{"./default-encoding":188,"./precondition":189,"./sync":190,"_process":192,"safe-buffer":217}],188:[function(require,module,exports){(function(process){var defaultEncoding
if(process.browser){defaultEncoding='utf-8'}else{var pVersionMajor=parseInt(process.version.split('.')[0].slice(1),10)
defaultEncoding=pVersionMajor>=6?'utf-8':'binary'}
module.exports=defaultEncoding}).call(this,require('_process'))},{"_process":192}],189:[function(require,module,exports){(function(Buffer){var MAX_ALLOC=Math.pow(2,30)-1
...
if(keylen<0||keylen>MAX_ALLOC||keylen!==keylen){throw new TypeError('Bad key length')}}}).call(this,{"isBuffer":require("../../is-buffer/index.js")})},{"../../is-buffer/index.js":152}],190:[function(require,module,exports){var md5=require('create-hash/md5')
var RIPEMD160=require('ripemd160')
var sha=require('sha.js')
...
return process.nextTick(function afterTick(){fn.apply(null,args);});}}}).call(this,require('_process'))},{"_process":192}],192:[function(require,module,exports){var process=module.exports={};var cachedSetTimeout;var cachedClearTimeout;function defaultSetTimout(){throw new Error('setTimeout has not been defined');}
...
process.binding=function(name){throw new Error('process.binding is not supported');};process.cwd=function(){return'/'};process.chdir=function(dir){throw new Error('process.chdir is not supported');};process.umask=function(){return 0;};},{}],193:[function(require,module,exports){exports.publicEncrypt=require('./publicEncrypt')
exports.privateDecrypt=require('./privateDecrypt')
exports.privateEncrypt=function privateEncrypt(key,buf){return exports.publicEncrypt(key,buf,true)}
exports.publicDecrypt=function publicDecrypt(key,buf){return exports.privateDecrypt(key,buf,true)}},{"./privateDecrypt":195,"./publicEncrypt":196}],194:[function(require,module,exports){var createHash=require('create-hash')
var Buffer=require('safe-buffer').Buffer
...
return out}},{"create-hash":101,"safe-buffer":217}],195:[function(require,module,exports){var parseKeys=require('parse-asn1')
var mgf=require('./mgf')
var xor=require('./xor')
var BN=require('bn.js')
var crt=require('browserify-rsa')
...
return dif}},{"./mgf":194,"./withPublic":197,"./xor":198,"bn.js":63,"browserify-rsa":86,"create-hash":101,"parse-asn1":185,"safe-buffer":217}],196:[function(require,module,exports){var parseKeys=require('parse-asn1')
...
num=cache[cur++]
if(num){out[i++]=num}}
return out}},{"./mgf":194,"./withPublic":197,"./xor":198,"bn.js":63,"browserify-rsa":86,"create-hash":101,"parse-asn1":185,"randombytes":199,"safe-buffer":217}],197:[function(require,module,exports){var BN=require('bn.js')
var Buffer=require('safe-buffer').Buffer
...
module.exports=withPublic},{"bn.js":63,"safe-buffer":217}],198:[function(require,module,exports){module.exports=function xor(a,b){var len=a.length
var i=-1
while(++i<len){a[i]^=b[i]}
return a}},{}],199:[function(require,module,exports){(function(process,global){'use strict'
var MAX_BYTES=65536
...
return bytes}}).call(this,require('_process'),typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})},{"_process":192,"safe-buffer":217}],200:[function(require,module,exports){(function(process,global){'use strict'
...
this._readableState.destroyed=value;this._writableState.destroyed=value;}});Duplex.prototype._destroy=function(err,cb){this.push(null);this.end();pna.nextTick(cb,err);};},{"./_stream_readable":204,"./_stream_writable":206,"core-util-is":99,"inherits":151,"process-nextick-args":191}],203:[function(require,module,exports){'use strict';module.exports=PassThrough;var Transform=require('./_stream_transform');var util=require('core-util-is');util.inherits=require('inherits');util.inherits(PassThrough,Transform);function PassThrough(options){if(!(this instanceof PassThrough))return new PassThrough(options);Transform.call(this,options);}
PassThrough.prototype._transform=function(chunk,encoding,cb){cb(null,chunk);};},{"./_stream_transform":205,"core-util-is":99,"inherits":151}],204:[function(require,module,exports){(function(process,global){'use strict';var pna=require('process-nextick-args');module.exports=Readable;var isArray=require('isarray');var Duplex;Readable.ReadableState=ReadableState;var EE=require('events').EventEmitter;var EElistenerCount=function(emitter,type){return emitter.listeners(type).length;};var Stream=require('./internal/streams/stream');var Buffer=require('safe-buffer').Buffer;var OurUint8Array=global.Uint8Array||function(){};function _uint8ArrayToBuffer(chunk){return Buffer.from(chunk);}
...
return-1;}}).call(this,require('_process'),typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})},{"./_stream_duplex":202,"./internal/streams/BufferList":207,"./internal/streams/destroy":208,"./internal/streams/stream":209,"_process":192,"core-util-is":99,"events":134,"inherits":151,"isarray":210,"process-nextick-args":191,"safe-buffer":217,"string_decoder/":211,"util":65}],205:[function(require,module,exports){'use strict';module.exports=Transform;var Duplex=require('./_stream_duplex');var util=require('core-util-is');util.inherits=require('inherits');util.inherits(Transform,Duplex);function afterTransform(er,data){var ts=this._transformState;ts.transforming=false;var cb=ts.writecb;if(!cb){return this.emit('error',new Error('write callback called multiple times'));}
...
this._writableState.destroyed=value;}});Writable.prototype.destroy=destroyImpl.destroy;Writable.prototype._undestroy=destroyImpl.undestroy;Writable.prototype._destroy=function(err,cb){this.end();cb(err);};}).call(this,require('_process'),typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{},require("timers").setImmediate)},{"./_stream_duplex":202,"./internal/streams/destroy":208,"./internal/streams/stream":209,"_process":192,"core-util-is":99,"inherits":151,"process-nextick-args":191,"safe-buffer":217,"timers":229,"util-deprecate":230}],207:[function(require,module,exports){'use strict';function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}
...
function simpleEnd(buf){return buf&&buf.length?this.write(buf):'';}},{"safe-buffer":217}],212:[function(require,module,exports){module.exports=require('./readable').PassThrough},{"./readable":213}],213:[function(require,module,exports){exports=module.exports=require('./lib/_stream_readable.js');exports.Stream=exports;exports.Readable=exports;exports.Writable=require('./lib/_stream_writable.js');exports.Duplex=require('./lib/_stream_duplex.js');exports.Transform=require('./lib/_stream_transform.js');exports.PassThrough=require('./lib/_stream_passthrough.js');},{"./lib/_stream_duplex.js":202,"./lib/_stream_passthrough.js":203,"./lib/_stream_readable.js":204,"./lib/_stream_transform.js":205,"./lib/_stream_writable.js":206}],214:[function(require,module,exports){module.exports=require('./readable').Transform},{"./readable":213}],215:[function(require,module,exports){module.exports=require('./lib/_stream_writable.js');},{"./lib/_stream_writable.js":206}],216:[function(require,module,exports){'use strict'
var Buffer=require('buffer').Buffer
var inherits=require('inherits')
var HashBase=require('hash-base')
var ARRAY16=new Array(16)
...
module.exports=RIPEMD160},{"buffer":97,"hash-base":136,"inherits":151}],217:[function(require,module,exports){var buffer=require('buffer')
...
return buffer.SlowBuffer(size)}},{"buffer":97}],218:[function(require,module,exports){(function(process){exports=module.exports=SemVer
var debug
if(typeof process==='object'&&process.env&&process.env.NODE_DEBUG&&/\bsemver\b/i.test(process.env.NODE_DEBUG)){debug=function(){var args=Array.prototype.slice.call(arguments,0)
args.unshift('SEMVER')
console.log.apply(console,args)}}else{debug=function(){}}
...
var STAR=R++
src[STAR]='(<|>)?=?\\s*\\*'
for(var i=0;i<R;i++){debug(i,src[i])
if(!re[i]){re[i]=new RegExp(src[i])}}
exports.parse=parse
function parse(version,options){if(!options||typeof options!=='object'){options={loose:!!options,includePrerelease:false}}
...
exports.valid=valid
function valid(version,options){var v=parse(version,options)
return v?v.version:null}
exports.clean=clean
function clean(version,options){var s=parse(version.trim().replace(/^[=v]+/,''),options)
return s?s.version:null}
exports.SemVer=SemVer
function SemVer(version,options){if(!options||typeof options!=='object'){options={loose:!!options,includePrerelease:false}}
if(version instanceof SemVer){if(version.loose===options.loose){return version}else{version=version.version}}else if(typeof version!=='string'){throw new TypeError('Invalid Version: '+version)}
...
if(!m[4]){this.prerelease=[]}else{this.prerelease=m[4].split('.').map(function(id){if(/^[0-9]+$/.test(id)){var num=+id
...
SemVer.prototype.compare=function(other){debug('SemVer.compare',this.version,this.options,other)
...
SemVer.prototype.inc=function(release,identifier){switch(release){case'premajor':this.prerelease.length=0
this.patch=0
this.minor=0
this.major++
...
this.prerelease=[]
break
case'pre':if(this.prerelease.length===0){this.prerelease=[0]}else{var i=this.prerelease.length
...
return this}
exports.inc=inc
function inc(version,release,loose,identifier){if(typeof(loose)==='string'){identifier=loose
loose=undefined}
try{return new SemVer(version,loose).inc(release,identifier).version}catch(er){return null}}
exports.diff=diff
function diff(version1,version2){if(eq(version1,version2)){return null}else{var v1=parse(version1)
var v2=parse(version2)
var prefix=''
if(v1.prerelease.length||v2.prerelease.length){prefix='pre'
var defaultResult='prerelease'}
for(var key in v1){if(key==='major'||key==='minor'||key==='patch'){if(v1[key]!==v2[key]){return prefix+key}}}
return defaultResult}}
exports.compareIdentifiers=compareIdentifiers
var numeric=/^[0-9]+$/function compareIdentifiers(a,b){var anum=numeric.test(a)
var bnum=numeric.test(b)
if(anum&&bnum){a=+a
b=+b}
return a===b?0:(anum&&!bnum)?-1:(bnum&&!anum)?1:a<b?-1:1}
exports.rcompareIdentifiers=rcompareIdentifiers
function rcompareIdentifiers(a,b){return compareIdentifiers(b,a)}
exports.major=major
function major(a,loose){return new SemVer(a,loose).major}
exports.minor=minor
function minor(a,loose){return new SemVer(a,loose).minor}
exports.patch=patch
function patch(a,loose){return new SemVer(a,loose).patch}
exports.compare=compare
function compare(a,b,loose){return new SemVer(a,loose).compare(new SemVer(b,loose))}
exports.compareLoose=compareLoose
function compareLoose(a,b){return compare(a,b,true)}
exports.rcompare=rcompare
function rcompare(a,b,loose){return compare(b,a,loose)}
exports.sort=sort
function sort(list,loose){return list.sort(function(a,b){return exports.compare(a,b,loose)})}
exports.rsort=rsort
function rsort(list,loose){return list.sort(function(a,b){return exports.rcompare(a,b,loose)})}
exports.gt=gt
function gt(a,b,loose){return compare(a,b,loose)>0}
exports.lt=lt
function lt(a,b,loose){return compare(a,b,loose)<0}
exports.eq=eq
function eq(a,b,loose){return compare(a,b,loose)===0}
exports.neq=neq
function neq(a,b,loose){return compare(a,b,loose)!==0}
exports.gte=gte
function gte(a,b,loose){return compare(a,b,loose)>=0}
exports.lte=lte
function lte(a,b,loose){return compare(a,b,loose)<=0}
exports.cmp=cmp
function cmp(a,op,b,loose){switch(op){case'===':if(typeof a==='object')
a=a.version
if(typeof b==='object')
b=b.version
return a===b
...
function Comparator(comp,options){if(!options||typeof options!=='object'){options={loose:!!options,includePrerelease:false}}
...
debug('comp',this)}
var ANY={}
Comparator.prototype.parse=function(comp){var r=this.options.loose?re[COMPARATORLOOSE]:re[COMPARATOR]
var m=comp.match(r)
...
Comparator.prototype.test=function(version){debug('Comparator.test',version,this.options.loose)
if(this.semver===ANY){return true}
if(typeof version==='string'){version=new SemVer(version,this.options)}
return cmp(version,this.operator,this.semver,this.options)}
Comparator.prototype.intersects=function(comp,options){if(!(comp instanceof Comparator)){throw new TypeError('a Comparator is required')}
if(!options||typeof options!=='object'){options={loose:!!options,includePrerelease:false}}
var rangeTmp
if(this.operator===''){rangeTmp=new Range(comp.value,options)
return satisfies(this.value,rangeTmp,options)}else if(comp.operator===''){rangeTmp=new Range(this.value,options)
...
exports.Range=Range
function Range(range,options){if(!options||typeof options!=='object'){options={loose:!!options,includePrerelease:false}}
...
this.raw=range
this.set=range.split(/\s*\|\|\s*/).map(function(range){return this.parseRange(range.trim())},this).filter(function(c){return c.length})
if(!this.set.length){throw new TypeError('Invalid SemVer Range: '+range)}
this.format()}
Range.prototype.format=function(){this.range=this.set.map(function(comps){return comps.join(' ').trim()}).join('||').trim()
return this.range}
Range.prototype.toString=function(){return this.range}
Range.prototype.parseRange=function(range){var loose=this.options.loose
range=range.trim()
...
var set=range.split(' ').map(function(comp){return parseComparator(comp,this.options)},this).join(' ').split(/\s+/)
if(this.options.loose){set=set.filter(function(comp){return!!comp.match(compRe)})}
set=set.map(function(comp){return new Comparator(comp,this.options)},this)
return set}
Range.prototype.intersects=function(range,options){if(!(range instanceof Range)){throw new TypeError('a Range is required')}
return this.set.some(function(thisComparators){return thisComparators.every(function(thisComparator){return range.set.some(function(rangeComparators){return rangeComparators.every(function(rangeComparator){return thisComparator.intersects(rangeComparator,options)})})})})}
exports.toComparators=toComparators
function toComparators(range,options){return new Range(range,options).set.map(function(comp){return comp.map(function(c){return c.value}).join(' ').trim().split(' ')})}
function parseComparator(comp,options){debug('comp',comp,options)
...
debug('stars',comp)
return comp}
function isX(id){return!id||id.toLowerCase()==='x'||id==='*'}
function replaceTildes(comp,options){return comp.trim().split(/\s+/).map(function(comp){return replaceTilde(comp,options)}).join(' ')}
function replaceTilde(comp,options){var r=options.loose?re[TILDELOOSE]:re[TILDE]
return comp.replace(r,function(_,M,m,p,pr){debug('tilde',comp,_,M,m,p,pr)
var ret
if(isX(M)){ret=''}else if(isX(m)){ret='>='+M+'.0.0 <'+(+M+1)+'.0.0'}else if(isX(p)){ret='>='+M+'.'+m+'.0 <'+M+'.'+(+m+1)+'.0'}else if(pr){debug('replaceTilde pr',pr)
ret='>='+M+'.'+m+'.'+p+'-'+pr+' <'+M+'.'+(+m+1)+'.0'}else{ret='>='+M+'.'+m+'.'+p+' <'+M+'.'+(+m+1)+'.0'}
debug('tilde return',ret)
return ret})}
function replaceCarets(comp,options){return comp.trim().split(/\s+/).map(function(comp){return replaceCaret(comp,options)}).join(' ')}
function replaceCaret(comp,options){debug('caret',comp,options)
var r=options.loose?re[CARETLOOSE]:re[CARET]
return comp.replace(r,function(_,M,m,p,pr){debug('caret',comp,_,M,m,p,pr)
var ret
if(isX(M)){ret=''}else if(isX(m)){ret='>='+M+'.0.0 <'+(+M+1)+'.0.0'}else if(isX(p)){if(M==='0'){ret='>='+M+'.'+m+'.0 <'+M+'.'+(+m+1)+'.0'}else{ret='>='+M+'.'+m+'.0 <'+(+M+1)+'.0.0'}}else if(pr){debug('replaceCaret pr',pr)
if(M==='0'){if(m==='0'){ret='>='+M+'.'+m+'.'+p+'-'+pr+' <'+M+'.'+m+'.'+(+p+1)}else{ret='>='+M+'.'+m+'.'+p+'-'+pr+' <'+M+'.'+(+m+1)+'.0'}}else{ret='>='+M+'.'+m+'.'+p+'-'+pr+' <'+(+M+1)+'.0.0'}}else{debug('no pr')
if(M==='0'){if(m==='0'){ret='>='+M+'.'+m+'.'+p+' <'+M+'.'+m+'.'+(+p+1)}else{ret='>='+M+'.'+m+'.'+p+' <'+M+'.'+(+m+1)+'.0'}}else{ret='>='+M+'.'+m+'.'+p+' <'+(+M+1)+'.0.0'}}
debug('caret return',ret)
return ret})}
function replaceXRanges(comp,options){debug('replaceXRanges',comp,options)
return comp.split(/\s+/).map(function(comp){return replaceXRange(comp,options)}).join(' ')}
function replaceXRange(comp,options){comp=comp.trim()
var r=options.loose?re[XRANGELOOSE]:re[XRANGE]
return comp.replace(r,function(ret,gtlt,M,m,p,pr){debug('xRange',comp,ret,gtlt,M,m,p,pr)
var xM=isX(M)
var xm=xM||isX(m)
var xp=xm||isX(p)
var anyX=xp
if(gtlt==='='&&anyX){gtlt=''}
if(xM){if(gtlt==='>'||gtlt==='<'){ret='<0.0.0'}else{ret='*'}}else if(gtlt&&anyX){if(xm){m=0}
p=0
if(gtlt==='>'){gtlt='>='
if(xm){M=+M+1
m=0
...
return ret})}
function replaceStars(comp,options){debug('replaceStars',comp,options)
return comp.trim().replace(re[STAR],'')}
function hyphenReplace($0,from,fM,fm,fp,fpr,fb,to,tM,tm,tp,tpr,tb){if(isX(fM)){from=''}else if(isX(fm)){from='>='+fM+'.0.0'}else if(isX(fp)){from='>='+fM+'.'+fm+'.0'}else{from='>='+from}
if(isX(tM)){to=''}else if(isX(tm)){to='<'+(+tM+1)+'.0.0'}else if(isX(tp)){to='<'+tM+'.'+(+tm+1)+'.0'}else if(tpr){to='<='+tM+'.'+tm+'.'+tp+'-'+tpr}else{to='<='+to}
return(from+' '+to).trim()}
Range.prototype.test=function(version){if(!version){return false}
if(typeof version==='string'){version=new SemVer(version,this.options)}
for(var i=0;i<this.set.length;i++){if(testSet(this.set[i],version,this.options)){return true}}
return false}
function testSet(set,version,options){for(var i=0;i<set.length;i++){if(!set[i].test(version)){return false}}
if(version.prerelease.length&&!options.includePrerelease){for(i=0;i<set.length;i++){debug(set[i].semver)
if(set[i].semver===ANY){continue}
if(set[i].semver.prerelease.length>0){var allowed=set[i].semver
if(allowed.major===version.major&&allowed.minor===version.minor&&allowed.patch===version.patch){return true}}}
return false}
return true}
exports.satisfies=satisfies
function satisfies(version,range,options){try{range=new Range(range,options)}catch(er){return false}
return range.test(version)}
exports.maxSatisfying=maxSatisfying
function maxSatisfying(versions,range,options){var max=null
var maxSV=null
try{var rangeObj=new Range(range,options)}catch(er){return null}
versions.forEach(function(v){if(rangeObj.test(v)){if(!max||maxSV.compare(v)===-1){max=v
maxSV=new SemVer(max,options)}}})
return max}
exports.minSatisfying=minSatisfying
function minSatisfying(versions,range,options){var min=null
var minSV=null
try{var rangeObj=new Range(range,options)}catch(er){return null}
versions.forEach(function(v){if(rangeObj.test(v)){if(!min||minSV.compare(v)===1){min=v
minSV=new SemVer(min,options)}}})
return min}
exports.minVersion=minVersion
function minVersion(range,loose){range=new Range(range,loose)
var minver=new SemVer('0.0.0')
if(range.test(minver)){return minver}
minver=new SemVer('0.0.0-0')
if(range.test(minver)){return minver}
minver=null
for(var i=0;i<range.set.length;++i){var comparators=range.set[i]
comparators.forEach(function(comparator){var compver=new SemVer(comparator.semver.version)
switch(comparator.operator){case'>':if(compver.prerelease.length===0){compver.patch++}else{compver.prerelease.push(0)}
compver.raw=compver.format()
case'':case'>=':if(!minver||gt(minver,compver)){minver=compver}
break
case'<':case'<=':break
...
function validRange(range,options){try{return new Range(range,options).range||'*'}catch(er){return null}}
exports.ltr=ltr
function ltr(version,range,options){return outside(version,range,'<',options)}
exports.gtr=gtr
function gtr(version,range,options){return outside(version,range,'>',options)}
exports.outside=outside
function outside(version,range,hilo,options){version=new SemVer(version,options)
...
var high=null
var low=null
comparators.forEach(function(comparator){if(comparator.semver===ANY){comparator=new Comparator('>=0.0.0')}
...
function prerelease(version,options){var parsed=parse(version,options)
return(parsed&&parsed.prerelease.length)?parsed.prerelease:null}
exports.intersects=intersects
function intersects(r1,r2,options){r1=new Range(r1,options)
r2=new Range(r2,options)
return r1.intersects(r2)}
exports.coerce=coerce
function coerce(version){if(version instanceof SemVer){return version}
if(typeof version!=='string'){return null}
var match=version.match(re[COERCE])
if(match==null){return null}
return parse(match[1]+'.'+(match[2]||'0')+'.'+(match[3]||'0'))}}).call(this,require('_process'))},{"_process":192}],219:[function(require,module,exports){var Buffer=require('safe-buffer').Buffer
...
module.exports=Hash},{"safe-buffer":217}],220:[function(require,module,exports){var exports=module.exports=function SHA(algorithm){algorithm=algorithm.toLowerCase()
...
exports.sha512=require('./sha512')},{"./sha":221,"./sha1":222,"./sha224":223,"./sha256":224,"./sha384":225,"./sha512":226}],221:[function(require,module,exports){var inherits=require('inherits')
...
return H}
module.exports=Sha},{"./hash":219,"inherits":151,"safe-buffer":217}],222:[function(require,module,exports){var inherits=require('inherits')
var Hash=require('./hash')
var Buffer=require('safe-buffer').Buffer
var K=[0x5a827999,0x6ed9eba1,0x8f1bbcdc|0,0xca62c1d6|0]
var W=new Array(80)
...
H.writeInt32BE(this._e|0,16)
return H}
module.exports=Sha1},{"./hash":219,"inherits":151,"safe-buffer":217}],223:[function(require,module,exports){var inherits=require('inherits')
...
return H}
module.exports=Sha224},{"./hash":219,"./sha256":224,"inherits":151,"safe-buffer":217}],224:[function(require,module,exports){var inherits=require('inherits')
var Hash=require('./hash')
var Buffer=require('safe-buffer').Buffer
...
return H}
module.exports=Sha256},{"./hash":219,"inherits":151,"safe-buffer":217}],225:[function(require,module,exports){var inherits=require('inherits')
...
return H}
module.exports=Sha384},{"./hash":219,"./sha512":226,"inherits":151,"safe-buffer":217}],226:[function(require,module,exports){var inherits=require('inherits')
var Hash=require('./hash')
var Buffer=require('safe-buffer').Buffer
...
source.on('end',cleanup);source.on('close',cleanup);dest.on('close',cleanup);dest.emit('pipe',source);return dest;};},{"events":134,"inherits":151,"readable-stream/duplex.js":201,"readable-stream/passthrough.js":212,"readable-stream/readable.js":213,"readable-stream/transform.js":214,"readable-stream/writable.js":215}],228:[function(require,module,exports){arguments[4][211][0].apply(exports,arguments)},{"dup":211,"safe-buffer":217}],229:[function(require,module,exports){(function(setImmediate,clearImmediate){var nextTick=require('process/browser.js').nextTick;var apply=Function.prototype.apply;var slice=Array.prototype.slice;var immediateIds={};var nextImmediateId=0;exports.setTimeout=function(){return new Timeout(apply.call(setTimeout,window,arguments),clearTimeout);};exports.setInterval=function(){return new Timeout(apply.call(setInterval,window,arguments),clearInterval);};exports.clearTimeout=exports.clearInterval=function(timeout){timeout.close();};function Timeout(id,clearFn){this._id=id;this._clearFn=clearFn;}
...
return copy;};},{}],232:[function(require,module,exports){module.exports=WildEmitter;function WildEmitter(){}
...
return result;};};WildEmitter.mixin(WildEmitter);},{}]},{},[13])(13)});