...
import * as modelTokenClientRequest from '../../../json/Auth/TSTokenClientRequest';
import * as modelTokenClientResponse from '../../../json/Auth/TSTokenClientResponse';
 ...
 */
export class HClientToken implements IHClientToken {
     ...
     *  }
     */
	constructor(public lakeNiceAuthClient: ILakeNiceAuthClient, public clientTokenHandlerOptions: any) {
