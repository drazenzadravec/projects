 ...
 */
export class HSample implements IHSample {
     ...
     *  }
     */
	constructor(public lakeNiceClient: ILakeNiceClient, public sampleHandlerOptions: any) {

		// local.
		let self = this;
		let parent = sampleHandlerOptions.parent;
		let item;

		let options = sampleHandlerOptions || {};
