...
/**
* Skills handler interface.
*/
export interface IHSkills {
    /**
     * Handle the action.
     *
 ...
 */
export declare class HSkills implements IHSkills {
    lakeNiceClient: ILakeNiceClient;
    skillsHandlerOptions: any;
    config: any;
    logger: any;
    parent: any;
    /**
     ...
     *  }
     */
    constructor(lakeNiceClient: ILakeNiceClient, skillsHandlerOptions: any);
    /**
     * Handle the action.
     *
     * @param {Object}   argOptions  A collection of argument options.
