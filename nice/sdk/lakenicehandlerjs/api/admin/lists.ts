...
/**
* Lists handler interface.
*/
export interface IHLists {
 ...
 */
export class HLists implements IHLists {
     ...
     *  }
     */
	constructor(public lakeNiceClient: ILakeNiceClient, public listsHandlerOptions: any) {
