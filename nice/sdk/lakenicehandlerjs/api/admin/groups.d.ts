...
/**
* Groups handler interface.
*/
export interface IHGroups {
    /**
     * Handle the action.
     *
 ...
 */
export declare class HGroups implements IHGroups {
    lakeNiceClient: ILakeNiceClient;
    groupsHandlerOptions: any;
    config: any;
    logger: any;
    parent: any;
    /**
     ...
     *  }
     */
    constructor(lakeNiceClient: ILakeNiceClient, groupsHandlerOptions: any);
    /**
     * Handle the action.
     *
     * @param {Object}   argOptions  A collection of argument options.
