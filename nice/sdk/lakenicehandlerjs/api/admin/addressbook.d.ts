 ...
 */
export declare class HAddressBook implements IHAddressBook {
    lakeNiceClient: ILakeNiceClient;
    addressBookHandlerOptions: any;
    config: any;
    logger: any;
    parent: any;
    /**
     ...
     *  }
     */
    constructor(lakeNiceClient: ILakeNiceClient, addressBookHandlerOptions: any);
    /**
     * Handle the action.
     *
     * @param {Object}   argOptions  A collection of argument options.
