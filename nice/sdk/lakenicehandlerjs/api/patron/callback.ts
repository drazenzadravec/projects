 ...
 */
export class HCallback implements IHCallback {
     ...
     *  }
     */
	constructor(public lakeNiceClient: ILakeNiceClient, public callbackHandlerOptions: any) {

		// local.
		let self = this;
		let parent = callbackHandlerOptions.parent;
		let item;

		let options = callbackHandlerOptions || {};
    ...
    */
	...
	assignRequestOptions(uniqueID: string, requestData?: any): any {
		...
		if (requestData === null) {
			...
			// Select the request method.
			switch (requestMethod) {
				case "requestImmediateCallbackAsync": {
					options.data = requestData;
					return options;
				}
				case "scheduleCallbackAsync": {
					options.data = requestData;
					return options;
				}
				default: {
