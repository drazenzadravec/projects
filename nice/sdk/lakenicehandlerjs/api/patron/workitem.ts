...
/**
* WorkItem handler interface.
*/
export interface IHWorkItem {
 ...
 */
export class HWorkItem implements IHWorkItem {
     ...
     * @param {Object}				workItemHandlerOptions	A collection of options.
     *        
     * @example                          
     *  options = {
	 *		debug: true
     *  }
     */
	constructor(public lakeNiceClient: ILakeNiceClient, public workItemHandlerOptions: any) {

		// local.
		let self = this;
		let parent = workItemHandlerOptions.parent;
		let item;

		let options = workItemHandlerOptions || {};
