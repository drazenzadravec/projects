 ...
 */
export declare class HReporting implements IHReporting {
    lakeNiceClient: ILakeNiceClient;
    reportingHandlerOptions: any;
    config: any;
    logger: any;
    parent: any;
    /**
     ...
     *  }
     */
    constructor(lakeNiceClient: ILakeNiceClient, reportingHandlerOptions: any);
    /**
     * Handle the action.
     *
     * @param {Object}   argOptions  A collection of argument options.
