 ...
 */
export declare class HPersonalCon implements IHPersonalCon {
    lakeNiceClient: ILakeNiceClient;
    personalConHandlerOptions: any;
    config: any;
    logger: any;
    parent: any;
    /**
     ...
     *  }
     */
    constructor(lakeNiceClient: ILakeNiceClient, personalConHandlerOptions: any);
    /**
     * Handle the action.
     *
     * @param {Object}   argOptions  A collection of argument options.
