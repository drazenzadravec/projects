...
*/
export interface IHScheduledCallbacksAgent {
    /**
     * Handle the action.
     *
 ...
 */
export declare class HScheduledCallbacksAgent implements IHScheduledCallbacksAgent {
    lakeNiceClient: ILakeNiceClient;
    scheduledCallbacksHandlerOptions: any;
    config: any;
    logger: any;
    parent: any;
    /**
     ...
     *  }
     */
    constructor(lakeNiceClient: ILakeNiceClient, scheduledCallbacksHandlerOptions: any);
    /**
     * Handle the action.
     *
     * @param {Object}   argOptions  A collection of argument options.
