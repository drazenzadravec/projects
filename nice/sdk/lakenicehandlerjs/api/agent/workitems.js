...
class HWorkItems {
     ...
     *  }
     */
    constructor(lakeNiceClient, workItemsHandlerOptions) {
        this.lakeNiceClient = lakeNiceClient;
        this.workItemsHandlerOptions = workItemsHandlerOptions;
        // local.
        let self = this;
        let parent = workItemsHandlerOptions.parent;
        let item;
        let options = workItemsHandlerOptions || {};
