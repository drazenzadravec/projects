 ...
 */
class HScheduledCallbacksAgent {
    /**
     * ScheduledCallbacks handler implementation.
     *
     ...
     *  }
     */
    constructor(lakeNiceClient, scheduledCallbacksHandlerOptions) {
        this.lakeNiceClient = lakeNiceClient;
        this.scheduledCallbacksHandlerOptions = scheduledCallbacksHandlerOptions;
        // local.
        let self = this;
        ...
        wildemitter.mixin(HScheduledCallbacksAgent);
    }
    /**
     * Handle the action.
     *
...
exports.HScheduledCallbacksAgent = HScheduledCallbacksAgent;
