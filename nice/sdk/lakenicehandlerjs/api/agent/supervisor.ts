...
/**
* Supervisor handler interface.
*/
export interface IHSupervisor {
...
/**
 * Supervisor handler implementation.
 */
export class HSupervisor implements IHSupervisor {
     ...
     * @param {Object}				supervisorHandlerOptions	A collection of options.
     *        
     * @example                          
     *  options = {
	 *		debug: true
     *  }
     */
	constructor(public lakeNiceClient: ILakeNiceClient, public supervisorHandlerOptions: any) {

		// local.
		let self = this;
		let parent = supervisorHandlerOptions.parent;
		let item;

		let options = supervisorHandlerOptions || {};
