...
/**
* Voicemails handler interface.
*/
export interface IHVoicemails {
    /**
     * Handle the action.
     *
 ...
 */
export declare class HVoicemails implements IHVoicemails {
    lakeNiceClient: ILakeNiceClient;
    voicemailsHandlerOptions: any;
    config: any;
    logger: any;
    parent: any;
    /**
     ...
     *  }
     */
    constructor(lakeNiceClient: ILakeNiceClient, voicemailsHandlerOptions: any);
    /**
     * Handle the action.
     *
     * @param {Object}   argOptions  A collection of argument options.
