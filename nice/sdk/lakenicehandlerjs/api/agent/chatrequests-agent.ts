 ...
 */
export class HChatRequestsAgent implements IHChatRequestsAgent {
     ...
     *  }
     */
	constructor(public lakeNiceClient: ILakeNiceClient, public chatRequestsHandlerOptions: any) {
		...
		wildemitter.mixin(HChatRequestsAgent);
	}
    ...
    */
	...
	assignRequestOptions(uniqueID: string, requestData?: any): any {
		...
		if (requestData === null) {
			...
			// Select the request method.
			switch (requestMethod) {
				case "sendChatTextPatronAsync": {
					options.data = requestData;
					return options;
				}
				case "transferToAgentAsync": {
					options.data = requestData;
					return options;
				}
				case "transferToSkillAsync": {
					options.data = requestData;
					return options;
				}
				case "notifyPatronAgentTypingAsync": {
					options.data = requestData;
					return options;
				}
				case "addSMSChatContactAsync": {
					options.data = requestData;
					return options;
				}
				default: {
