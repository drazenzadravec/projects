 ...
 */
export class AmazonConnectInterface {

	ccpConfig: any;

	// amazon connect connection object.
	awsConnect: any;

	private eventRefreshContact: (contact: any, env: any) => void;
	private eventIncomingContact: (contact: any, env: any) => void;
	private eventAcceptedContact: (contact: any, env: any) => void;
	private eventEndedContact: (contact: any) => void;
	private eventConnectedContact: (contact: any) => void;
	private eventConnectingContact: (contact: any, contactId: string, connectionId: string, env: any) => void;
	private eventRefreshAgent: (agent: any, env: any) => void;
	private eventStateChangeAgent: (agent: any, env: any) => void;
	private eventRoutableAgent: (agent: any, env: any) => void;
	private eventNotRoutableAgent: (agent: any, env: any) => void;
	private eventOfflineAgent: (agent: any, env: any) => void;
	private eventErrorAgent: (agent: any, env: any) => void;
	private eventAfterCallWorkAgent: (agent: any, env: any) => void;
	private eventMuteToggleAgent: (agent: any, env: any) => void;
	 ...
	 *	};
	 */
	constructor(public ccpOptions: any, public acConnect: any) {
