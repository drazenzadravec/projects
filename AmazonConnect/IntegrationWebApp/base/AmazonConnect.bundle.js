...
class AmazonConnect {
     ...
     * @param {string}	phoneNumber   the incoming contact phone humber.
     * @return {boolean}   True if the contact was added; else false.
    */
    addContact(contact, connection, contactId, connectionId, phoneNumber) {
...
class AmazonConnectContact {
     ...
     * @param {string}	phoneNumber   the incoming contact phone humber.
     */
    assignContact(contact, connection, contactId, connectionId, phoneNumber) {
        // assign each value.
